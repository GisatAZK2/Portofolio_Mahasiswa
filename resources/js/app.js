...
<table><thead><tr><th>NO</th><th>NAMA LENGKAP</th><th>USERNAME</th><th>EMAIL</th><th>ROLE</th><th>STATUS PENGAJUAN</th><th>STATUS AKTIF</th><th>JURUSAN/PRODI</th><th>ANGKATAN</th></tr></thead><tbody>`;
    ...
    function updateSelectedIds() {
        ...
        const hasPending = selectedCheckboxes.some(cb => {
            ...
            return text.includes('menunggu') || text.includes('sedang di ajukan');
        });
    ...
    window.toggleAll = function (source, onlyVisible = false) {
    ...
    document.addEventListener('DOMContentLoaded', function () {
        ...
        const selectAllCheckbox = document.getElementById('selectAllCheckbox');
        if (selectAllCheckbox) selectAllCheckbox.addEventListener('change', function () { window.toggleAll(this, false); });

        const tableSelectAllCheckbox = document.getElementById('tableSelectAllCheckbox');
        if (tableSelectAllCheckbox) tableSelectAllCheckbox.addEventListener('change', function () { window.toggleAll(this, true); });
