                                        ...
                                        <div>
                                            ...
                                            @if($project->leader->jurusan)
                                                <p class="text-xs text-gray-500 dark:text-gray-400">
                                                    {{ $project->leader->jurusan->nama_jurusan }}</p>
                                            @endif
                                        </div>
                                    </div>
                                @else
                                    <p class="text-gray-500 dark:text-gray-400 text-sm italic">Belum ada leader yang ditunjuk
                                    </p>
                                @endif
                            </div>
                                    ...
                                    <a href="{{ $project->isi_content['link_project'] }}" target="_blank"
                                        ...
                                        <div class="flex-1">
                                            ...
                                            <p class="text-xs text-gray-500 dark:text-gray-400 truncate">
                                                {{ $project->isi_content['link_project'] }}</p>
                                        </div>
                                    </a>
                                @endif
                                    ...
                                    <a href="{{ $project->isi_content['link_github'] }}" target="_blank"
                                        ...
                                        <div class="flex-1">
                                            <p
                                                ...
                                                GitHub Repository</p>
                                            <p class="text-xs text-gray-500 dark:text-gray-400 truncate">
                                                {{ $project->isi_content['link_github'] }}</p>
                                        </div>
                                    </a>
                                @endif
                                    ...
                                    <a href="{{ $project->isi_content['link_video'] }}" target="_blank"
                                        ...
                                        <div class="flex-1">
                                            <p
                                                ...
                                                Video Demo</p>
                                            <p class="text-xs text-gray-500 dark:text-gray-400 truncate">
                                                {{ $project->isi_content['link_video'] }}</p>
                                        </div>
                                    </a>
                                @endif
