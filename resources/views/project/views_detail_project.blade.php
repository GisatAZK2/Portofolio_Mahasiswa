...
@section('content')
    ...
    <div class="min-h-screen bg-gray-50 dark:bg-gray-800 transition-colors duration-200">
        <div class="p-4 sm:p-6 lg:p-10 space-y-6 sm:space-y-8 lg:space-y-10 max-w-7xl mx-auto">
            ...
            <!-- PROJECT CARD -->
            <div class="bg-white dark:bg-gray-800 rounded-2xl shadow-sm border border-gray-200 dark:border-gray-700 p-4 sm:p-6 lg:p-8 hover:shadow-md transition-shadow duration-300">
                ...
                <div class="mb-6">
                    ...
                    <div class="flex flex-wrap items-center justify-between gap-3 mb-3">
                        <div class="flex items-center gap-3">
                            <span class="px-3 py-1 rounded-full text-xs font-semibold {{ $statusColor }}" data-translate="status_{{ $status }}" data-translate-page="project_detail">
                                {{ $statusText }}
                            </span>
                            @if($status !== 'past')
                                <span class="text-sm text-gray-600 dark:text-gray-400">
                                    {{ $progress }}% <span data-translate="progress_done" data-translate-page="project_detail">Selesai</span>
                                </span>
                            @endif
                        </div>

                        <!-- Project Title -->
                        <h1 class="text-xl sm:text-2xl font-bold text-gray-900 dark:text-white order-first sm:order-none w-full sm:w-auto">
                                ...
                                <div class="space-y-2">
                                    @forelse($project->members as $member)
                                        @if($member->id !== $project->leader_id)
                                            <div class="flex items-center gap-3 p-2 bg-white dark:bg-gray-800 rounded-lg border border-gray-200 dark:border-gray-600 max-w-max">
                                                ...
                                                @else
                                                    <div class="w-8 h-8 bg-indigo-100 dark:bg-indigo-900 flex items-center justify-center text-indigo-700 dark:text-indigo-300 text-xs font-bold rounded-full border border-gray-200 dark:border-gray-600">
                    ...
                    <div class="space-y-6">
                        ...
                        <div class="bg-gray-50 dark:bg-gray-700/30 rounded-xl p-5">
                            ...
                            <div class="flex items-center gap-4 text-sm">
                                <div class="flex-1 p-3 bg-white dark:bg-gray-800 rounded-lg border border-gray-200 dark:border-gray-600">
                                ...
                                @if(!empty($project->isi_content['link_project']))
                                    <a href="{{ $project->isi_content['link_project'] }}" 
                                       ...
                                       class="flex items-center gap-3 p-3 bg-white dark:bg-gray-800 rounded-lg border border-gray-200 dark:border-gray-600 hover:border-indigo-300 dark:hover:border-indigo-600 transition group">
                                        ...
                                        <div class="flex-1">
                                            <p class="text-sm font-medium text-gray-900 dark:text-white group-hover:text-indigo-600 dark:group-hover:text-indigo-400">Website Proyek</p>
                                            <p class="text-xs text-gray-500 dark:text-gray-400 truncate">{{ $project->isi_content['link_project'] }}</p>
                                        </div>
                                    </a>
                                @endif
                                ...
                                @if(!empty($project->isi_content['link_github']))
                                    <a href="{{ $project->isi_content['link_github'] }}" 
                                       ...
                                       class="flex items-center gap-3 p-3 bg-white dark:bg-gray-800 rounded-lg border border-gray-200 dark:border-gray-600 hover:border-gray-400 dark:hover:border-gray-500 transition group">
                                        ...
                                        <div class="flex-1">
                                            <p class="text-sm font-medium text-gray-900 dark:text-white group-hover:text-gray-700 dark:group-hover:text-gray-300">GitHub Repository</p>
                                            <p class="text-xs text-gray-500 dark:text-gray-400 truncate">{{ $project->isi_content['link_github'] }}</p>
                                        </div>
                                    </a>
                                @endif
                                ...
                                @if(!empty($project->isi_content['link_video']))
                                    <a href="{{ $project->isi_content['link_video'] }}" 
                                       ...
                                       class="flex items-center gap-3 p-3 bg-white dark:bg-gray-800 rounded-lg border border-gray-200 dark:border-gray-600 hover:border-red-300 dark:hover:border-red-600 transition group">
                                        ...
                                        <div class="flex-1">
                                            <p class="text-sm font-medium text-gray-900 dark:text-white group-hover:text-red-600 dark:group-hover:text-red-400">Video Demo</p>
                                            <p class="text-xs text-gray-500 dark:text-gray-400 truncate">{{ $project->isi_content['link_video'] }}</p>
                                        </div>
                                    </a>
                                @endif

                                @if(empty($project->isi_content['link_project']) && empty($project->isi_content['link_github']) && empty($project->isi_content['link_video']))
                                    <p class="text-gray-500 dark:text-gray-400 text-sm italic text-center py-4">Belum ada link terkait</p>
                                @endif
                            </div>
                        </div>
            ...
            <div class="bg-white dark:bg-gray-800 rounded-2xl shadow-sm border border-gray-200 dark:border-gray-700 p-4 sm:p-6 lg:p-8 hover:shadow-md transition-shadow duration-300">
                ...
                @if ($entries->isEmpty())
                    <div class="text-center py-16 bg-gray-50 dark:bg-gray-700/30 rounded-xl border border-gray-200 dark:border-gray-700">
                        <svg class="w-16 h-16 mx-auto text-gray-400 dark:text-gray-500 mb-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 6.253v13m0-13C10.832 5.477 9.246 5 7.5 5S4.168 5.477 3 6.253v13C4.168 18.477 5.754 18 7.5 18s3.332.477 4.5 1.253m0-13C13.168 5.477 14.754 5 16.5 5c1.747 0 3.332.477 4.5 1.253v13C19.832 18.477 18.247 18 16.5 18c-1.746 0-3.332.477-4.5 1.253" />
                        </svg>
                        <p class="text-gray-600 dark:text-gray-400 text-lg font-medium">Belum ada catatan learning corner</p>
                        <p class="text-gray-500 dark:text-gray-500 text-sm mt-2">Mulai tambahkan catatan pertama untuk proyek ini</p>
                    </div>
                @else
                    ...
                    <div class="space-y-4 sm:space-y-5 lg:space-y-6">
                        @foreach ($entries as $index => $entry)
                            ...
                            <div class="bg-gray-50 dark:bg-gray-700/30 rounded-xl p-5 shadow-sm hover:shadow-lg transition-all duration-300 border border-gray-200 dark:border-gray-700">
    ...
    <!-- Image Modal -->
    <div id="imageModal" class="fixed inset-0 bg-black/90 z-50 hidden items-center justify-center p-4 transition-opacity duration-300" onclick="closeImageModal()">
