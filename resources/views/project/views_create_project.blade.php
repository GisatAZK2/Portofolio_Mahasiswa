    ...
    <script>
        ...
        function addMemberSelect(savedValue = null) {
            ...
            usersData.forEach(user => {
                ...
                optionsHtml += `<option value="${user.id}" data-name="${user.nama_mahasiswa}" data-original="${user.nama_mahasiswa}" ${selected}>${user.nama_mahasiswa}</option>`;
            });
