        ...
        <div class="relative w-full max-w-lg">
            ...
            <div class="relative mb-13 sm:mb-15">
                <h1 class="text-4xl sm:text-5xl md:text-6xl font-black text-gray-900 tracking-tight leading-none rotate-[-1.8deg] inline-block"
                    data-translate="title" data-translate-page="forgot_password">
                    Lupa Password
                </h1>
                <p class="mt-3 text-base sm:text-lg text-gray-600 max-w-md rotate-[-0.8deg]"
                   data-translate="subtitle" data-translate-page="forgot_password">
                    Tenang, kami akan kirimkan kode OTP ke email kamu.
                </p>
                <div class="absolute -top-4 -left-8 w-24 sm:w-32 h-1 bg-orange-400 rotate-[-42deg] rounded-full opacity-80"></div>
            </div>
            ...
            <form method="POST" action="{{ route('password.sendOtp') }}" class="space-y-7 mt-30 sm:space-y-8">
                ...
                <div>
                    <label for="email" class="block text-sm font-medium text-gray-700 mb-1.5"
                           data-translate="label_email" data-translate-page="forgot_password">
                        Alamat Email
                    </label>
                    <input type="email" name="email" id="email" required autofocus value="{{ old('email') }}"
                        ...
                        placeholder="{{ __('email_placeholder') }}" data-translate-placeholder="email_placeholder" data-translate-page="forgot_password">
                    @error('email')
                        <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                    @enderror
                    <p class="mt-2 text-xs text-gray-500"
                       data-translate="email_hint" data-translate-page="forgot_password">
                ...
                <div class="mt-20 flex flex-col gap-6 sm:gap-8">
                    <div class="flex flex-col sm:flex-row gap-3 sm:gap-4">
                        <a href="{{ route('login') }}"
                            ...
                            data-translate="btn_cancel" data-translate-page="forgot_password">
                            Batal
                        </a>
                        <button type="submit"
                            ...
                            data-translate="btn_submit" data-translate-page="forgot_password">
                            Kirim Kode OTP →
                        </button>
                    </div>
                </div>
