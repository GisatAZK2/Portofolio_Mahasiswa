                ...
                <div class="bg-white rounded-xl shadow-sm border border-gray-200 overflow-hidden">
                    ...
                    <div class="relative h-48 bg-gradient-to-br from-indigo-500 via-indigo-600 to-blue-600">
                        <div class="absolute -bottom-16 left-1/2 -translate-x-1/2 group">
                            <div
                                class="relative w-32 h-32 rounded-full border-4 border-white bg-white shadow-lg overflow-hidden ring-1 ring-gray-200/50">
                    ...
                    <div class="pt-20 px-6 pb-10 sm:px-10">
                        <div class="text-center mb-1 relative group">
                            <div id="nama-container">
                                <h2 id="nama-display"
                                    class="text-2xl md:text-3xl font-bold text-gray-900 inline-block cursor-pointer"
                                    onclick="toggleEdit('nama')">
                                    {{ Auth::user()->nama_mahasiswa ?? 'Mahasiswa' }}
                                </h2>
                                <button type="button" onclick="toggleEdit('nama')"
                                    class="ml-2 opacity-0 group-hover:opacity-100 transition text-gray-400 hover:text-indigo-600">
                                    ✏️
                                </button>
                            </div>
                        ...
                        <div class="grid grid-cols-1 sm:grid-cols-2 gap-5 max-w-3xl mx-auto">
                            ...
                            <div class="bg-gray-50/70 p-5 rounded-lg border border-gray-100 hover:border-indigo-200 transition relative group cursor-pointer"
                            ...
                            <div class="bg-gray-50/70 p-5 rounded-lg border border-gray-100 hover:border-indigo-200 transition relative group cursor-pointer"
                                ...
                                <select id="jurusan-input" name="id_jurusan"
                                    class="hidden w-full text-base font-medium border-b border-indigo-500 focus:outline-none bg-white">
                            ...
                            <div class="bg-gray-50/70 p-5 rounded-lg border border-gray-100 sm:col-span-1">
                                ...
                                <div class="flex items-center gap-2">
                                    <span
                                        class="inline-block w-3 h-3 rounded-full {{ Auth::user()->is_active ? 'bg-green-500' : 'bg-red-500' }}"></span>
                                    <p
                                        class="text-base font-medium {{ Auth::user()->is_active ? 'text-green-700' : 'text-red-700' }}">
                        ...
                        <div id="save-button-container" class="mt-10 text-center hidden">
                            ...
                            <button type="button" onclick="window.location.reload()"
                                class="ml-4 px-6 py-3 bg-gray-200 text-gray-700 rounded-lg hover:bg-gray-300 transition">
                                Batal
                            </button>
                        </div>
                    </div>
                                ...
                                <div
                                    ...
                                    @if($embedVideo)
                                        <div class="relative w-full pb-[56.25%] bg-black">
                                            <iframe class="absolute inset-0 w-full h-full" src="{{ $embedVideo }}"
                                    ...
                                    @elseif($linkProject)
                                        <div
                                            class="w-full h-48 bg-gradient-to-br from-indigo-50 to-blue-50 flex items-center justify-center">
