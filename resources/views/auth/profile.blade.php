                    ...
                    <div class="rounded-lg shadow-lg p-4" :class="{
                        ...
                        <div class="flex items-start">
                            <div class="flex-shrink-0">
                                ...
                                <svg x-show="alertType === 'warning'" class="w-5 h-5 text-yellow-600 dark:text-yellow-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        ...
                        <div class="bg-gray-50 dark:bg-gray-700/50 p-5 rounded-lg border border-gray-200 dark:border-gray-600 sm:col-span-2">
                            ...
                            <template x-if="!loading">
                                <div class="space-y-3 mb-4">
                                    ...
                                    <!-- Empty State -->
                                    <div x-show="keahlianList.length === 0" class="text-center py-8 text-gray-500 dark:text-gray-400">
                                        ...
                                        <p class="text-sm mt-1 text-gray-500 dark:text-gray-500">Tambahkan keahlian baru di bawah</p>
                                    </div>
                                </div>
                            </template>
                            ...
                            <div x-show="keahlianCount < 3" class="mt-4 pt-4 border-t border-gray-200 dark:border-gray-700">
                                <form action="{{ route('keahlian-tambahan.store') }}" method="POST">
                                    ...
                                    <div class="flex flex-col sm:flex-row gap-3">
                                        <select name="id_keahlian_tambahan" class="flex-1 px-4 py-2 border border-gray-300 dark:border-gray-600 rounded-lg focus:ring-2 focus:ring-indigo-500 focus:border-transparent dark:bg-gray-800 dark:text-white">
                            ...
                            <div x-show="keahlianCount >= 3" class="mt-4 p-4 bg-yellow-50 dark:bg-yellow-900/20 rounded-lg border border-yellow-200 dark:border-yellow-800">
                                <p class="text-sm text-yellow-800 dark:text-yellow-200 flex items-center">
                                    ...
                                    Anda sudah mencapai maksimal 3 keahlian tambahan. Hapus salah satu untuk menambah keahlian baru.
                                </p>
                            </div>
                        </div>
