        ...
        <div class="relative w-full max-w-lg fade-in-up">
            ...
            <div class="relative mb-8 sm:mb-12">
                <a href="{{ route('password.forgot') }}" class="inline-flex items-center text-blue-600 hover:text-blue-700 mb-4 group transition-all duration-300"
                   data-translate="back_to_forgot" data-translate-page="verify_otp">
                    <svg class="w-5 h-5 mr-2 transform group-hover:-translate-x-1 transition-transform" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M10 19l-7-7m0 0l7-7m-7 7h18"></path>
                    </svg>
                    Kembali ke Lupa Password
                </a>
                <h1 class="text-4xl sm:text-5xl md:text-6xl font-black text-gray-900 tracking-tight leading-none rotate-[-1.8deg] inline-block bg-gradient-to-r from-blue-600 to-indigo-600 bg-clip-text text-transparent"
                    data-translate="title" data-translate-page="verify_otp">
                    Verifikasi OTP
                </h1>
                <p class="mt-3 text-base sm:text-lg text-gray-600 max-w-md rotate-[-0.8deg]"
                   data-translate="subtitle" data-translate-page="verify_otp">
                ...
                <div class="flex items-start">
                    ...
                    <div class="ml-3">
                        <p class="text-sm text-blue-700"
                           data-translate="otp_sent_to" data-translate-page="verify_otp">
                            Kode OTP telah dikirim ke: <strong id="email-display">{{ $email ?? old('email') }}</strong>
                        </p>
                        <p class="text-xs text-blue-600 mt-1"
                           data-translate="otp_validity" data-translate-page="verify_otp">
            ...
            <form method="POST" action="{{ route('password.verify') }}" class="space-y-7 sm:space-y-8" id="otpForm">
                ...
                <div>
                    <label for="otp" class="block text-sm font-medium text-gray-700 mb-1.5"
                           data-translate="label_otp" data-translate-page="verify_otp">
                        Kode OTP
                    </label>
                    <div class="relative">
                    ...
                    <div class="mt-2 flex items-center justify-between text-xs">
                        <p class="text-gray-500"
                           data-translate="otp_hint" data-translate-page="verify_otp">
                        ...
                        <button type="button"
                            ...
                            data-translate="btn_resend" data-translate-page="verify_otp">
                            Kirim Ulang Kode
                        </button>
                    </div>
                    @error('otp')
                    ...
                    <div class="flex items-center justify-between">
                        <div class="flex items-center gap-2">
                            ...
                            <span class="text-sm text-gray-600"
                                  data-translate="timer_label" data-translate-page="verify_otp">Kode berlaku selama:</span>
                        </div>
                        <div class="font-mono text-lg font-bold text-blue-600" id="timer">05:00</div>
                    </div>
                ...
                <div class="mt-8 flex flex-col sm:flex-row justify-end gap-3 sm:gap-4">
                    <a href="{{ route('password.forgot') }}"
                        ...
                        data-translate="btn_cancel" data-translate-page="verify_otp">
                        Batal
                    </a>
                    <button type="submit"
                        ...
                        data-translate="btn_verify" data-translate-page="verify_otp">
                        Verifikasi OTP →
                    </button>
                </div>
                ...
                <div class="text-center mt-4">
                    <p class="text-gray-600 text-sm"
                       data-translate="or_login" data-translate-page="verify_otp">
                        Atau
                        <a href="{{ route('login') }}"
                            class="text-blue-600 hover:text-blue-800 hover:underline"
                            data-translate="back_to_login_link" data-translate-page="verify_otp">
