                                ...
                                <div class="relative flex items-end justify-center gap-4 min-h-[280px]">
                                    ...
                                    @if($top3->count() >= 2)
                                        ...
                                        <div class="text-center flex-1 pb-8">
                                            <a href="{{ route('portfolio.slug', ['slug' => $user2->slug]) }}" class="relative inline-block">
                                            ...
                                            <div class="mt-2">
                                                <a href="{{ route('portfolio.slug', ['slug' => $user2->slug]) }}" class="text-gray-800 dark:text-white font-semibold text-xs truncate max-w-[100px] mx-auto block hover:text-blue-600 transition">
                                    ...
                                    @if($top3->count() >= 1)
                                        ...
                                        <div class="text-center flex-1 -mt-8">
                                            <a href="{{ route('portfolio.slug', ['slug' => $user1->slug]) }}" class="relative inline-block">
                                            ...
                                            <div class="mt-3">
                                                <a href="{{ route('portfolio.slug', ['slug' => $user1->slug]) }}" class="text-gray-800 dark:text-white font-bold text-sm truncate max-w-[120px] mx-auto block hover:text-blue-600 transition">
                                    ...
                                    @if($top3->count() >= 3)
                                        ...
                                        <div class="text-center flex-1 pb-8">
                                            <a href="{{ route('portfolio.slug', ['slug' => $user3->slug]) }}" class="relative inline-block">
                                            ...
                                            <div class="mt-2">
                                                <a href="{{ route('portfolio.slug', ['slug' => $user3->slug]) }}" class="text-gray-800 dark:text-white font-semibold text-xs truncate max-w-[100px] mx-auto block hover:text-blue-600 transition">
                                    ...
                                    <div class="flex flex-col items-center justify-center gap-6">
                                        @if($top3->count() >= 2)
                                            ...
                                            <div class="text-center w-full">
                                                ...
                                                <div class="mt-3">
                                                    <a href="{{ route('portfolio.slug', ['slug' => $user2->slug]) }}" class="text-gray-800 dark:text-white font-semibold text-sm truncate max-w-[120px] mx-auto block hover:text-blue-600 transition">
                                                        {{ $user2->nama_mahasiswa ?? 'User' }}
                                                    </a>
                                        ...
                                        @if($top3->count() >= 1)
                                            ...
                                            <div class="text-center w-full">
                                                ...
                                                <div class="mt-4">
                                                    <a href="{{ route('portfolio.slug', ['slug' => $user1->slug]) }}" class="text-gray-800 dark:text-white font-bold text-base truncate max-w-[150px] mx-auto block hover:text-blue-600 transition">
                                                        {{ $user1->nama_mahasiswa ?? 'User' }}
                                                    </a>
                                        ...
                                        @if($top3->count() >= 3)
                                            ...
                                            <div class="text-center w-full">
                                                ...
                                                <div class="mt-3">
                                                    <a href="{{ route('portfolio.slug', ['slug' => $user3->slug]) }}" class="text-gray-800 dark:text-white font-semibold text-sm truncate max-w-[120px] mx-auto block hover:text-blue-600 transition">
                                                        {{ $user3->nama_mahasiswa ?? 'User' }}
                                                    </a>
                        ...
                        <div class="divide-y divide-gray-100 dark:divide-gray-700">
                            @forelse($games as $index => $item)
                                @php
                                    ...
                                    $totalTime = $item['total_playing_time'] ?? 0;
                                    $formattedTime = '';
                                    if (is_numeric($totalTime)) {
                                        ...
                                        if (preg_match('/(\d+)/', $totalTime, $matches)) {
                                            $secondsNum = (int)$matches[1];
                                            $minutes = floor($secondsNum / 60);
                                            $seconds = $secondsNum % 60;
                                            $formattedTime = sprintf('%02d:%02d', $minutes, $seconds);
                                        } else {
                                            $formattedTime = $totalTime ?: '0:00';
                                        }
                                    }
                                @endphp
                                <div class="py-3 md:py-4 hover:bg-gray-50 dark:hover:bg-gray-700/50 transition-colors duration-150 rounded-lg px-3">
                                    <div class="grid grid-cols-12 gap-3 md:gap-4 items-center">
                                        ...
                                        <div class="col-span-7 md:col-span-4">
                                            <a href="{{ route('portfolio.slug', ['slug' => $user->slug]) }}" class="flex items-center gap-3 group">
                                                ...
                                                <div class="min-w-0 flex-1">
                                                    <div class="font-semibold text-gray-800 dark:text-white text-sm md:text-base truncate group-hover:text-blue-600 dark:group-hover:text-blue-400 transition">
                                        ...
                                        <div class="hidden md:block md:col-span-1 text-center">
                                            @if(isset($item['game_name']) && $item['game_name'] !== 'multiple')
