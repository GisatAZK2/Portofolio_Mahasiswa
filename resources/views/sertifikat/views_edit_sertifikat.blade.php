...
<div class="min-h-screen">
    <div class=" p-8">
        ...
        <!-- Form -->
        <form method="POST" action="{{ route('sertifikat.update', $sertifikat->id) }}" enctype="multipart/form-data" class="space-y-7">
            @csrf
            @method('PUT')
                ...
                <div class="flex items-start justify-between">
                    <div class="flex items-center gap-3">
                        ...
                        <div>
                            ...
                            <a href="{{ Storage::url($sertifikat->link_sertifikat) }}" 
                               target="_blank"
            ...
            <div id="current-image-preview" class="mt-4 p-4 bg-gray-50 rounded-lg border border-gray-200">
                ...
                <img src="{{ Storage::url($sertifikat->link_sertifikat) }}" 
                     alt="Current Sertifikat" 
