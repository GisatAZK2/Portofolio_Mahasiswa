                            ...
                            @foreach($user->projects as $project)
                                ...
                                <div class="border border-gray-100 rounded-xl p-5 hover:shadow-md transition">
                                    <div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
                                                    ...
                                                    <a href="{{ $linkVideo }}" target="_blank" rel="noopener noreferrer"
                                                       class="inline-flex items-center text-sm text-red-600 hover:text-red-800 font-medium">
                                                        <svg class="w-4 h-4 mr-1" fill="currentColor" viewBox="0 0 24 24">
                                                            <path d="M21.5 10.833l-7.5 4.33v-8.66l7.5 4.33zM2 5h12v2H4v10h10v2H2V5zm16 2v10l-8-5 8-5z"/>
                                                        </svg>
                                                        Video Demo
                                                    </a>
                                                @endif
                                        ...
                                        @if($videoId)
                                            <div class="relative w-full aspect-video rounded-lg overflow-hidden bg-black/5 shadow-inner">
                                                <iframe
                                                    class="absolute inset-0 w-full h-full"
                                                    src="https://www.youtube.com/embed/{{ $videoId }}?rel=0&modestbranding=1&showinfo=0&controls=1"
                                                    title="YouTube video player for {{ $nama }}"
                                                    frameborder="0"
                                            ...
                                            @if($linkSertif)
                                                <div class="mt-5">
                                                    <a href="{{ $linkSertif }}" target="_blank" rel="noopener noreferrer"
                                                       class="inline-flex items-center px-5 py-2.5 bg-amber-600 text-white text-sm font-medium rounded-lg hover:bg-amber-700 transition">
                                        ...
                                        @if($linkSertif)
                                            <div class="relative w-full aspect-[4/3] rounded-lg overflow-hidden bg-gray-100 shadow-inner flex items-center justify-center">
                                                @if($isImage)
                                                    ...
                                                    <div class="absolute inset-0 hidden flex items-center justify-center bg-gray-200 text-gray-500 text-xs">
                                                ...
                                                @elseif(($item['type'] ?? '') === 'image' && !empty($item['content']))
                                                    <div class="my-3">
                                                        <img src="{{ asset('storage/' . $item['content']) }}"
                                                            alt="Gambar learning corner"
                                                            class="w-30 rounded-lg shadow-sm object-cover max-h-[500px]"
                                                            loading="lazy"
