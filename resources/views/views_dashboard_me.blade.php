...
@section('content')
    <style>
        ...
        .post-action-btn.btn-photo:hover {
            background: #eff6ff;
            border-color: #93c5fd;
            color: #1d4ed8;
        }

        .post-action-btn.btn-photo:hover svg {
            color: #1d4ed8;
        }

        .post-action-btn.btn-article:hover {
            background: #fdf2f8;
            border-color: #f9a8d4;
            color: #9d174d;
        }

        .post-action-btn.btn-article:hover svg {
            color: #9d174d;
        }
        ...
        .cp-add-item-btn:hover {
            background: #ede9fe;
            border-color: #c4b5fd;
            color: #5b21b6;
        }

        .dark .cp-add-item-btn {
            background: #374151;
            border-color: #4b5563;
            color: #9ca3af;
        }
        ...
        .cp-btn-submit.submit-photo {
            background: #2563eb;
        }

        .cp-btn-submit.submit-photo:hover {
            background: #1d4ed8;
        }

        .cp-btn-submit.submit-article {
            background: #be185d;
        }

        .cp-btn-submit.submit-article:hover {
            background: #9d174d;
        }

        .cp-btn-submit.submit-post {
            background: #4f46e5;
        }

        .cp-btn-submit.submit-post:hover {
            background: #4338ca;
        }
