...
@section('content')
<!-- Detail Postingan Styles migrated to app.css -->
...
<div id="postingan-detail-container"
     data-page-info="detail-postingan"
     ...
     data-post-url="{{ route('postingan.show', ['locale' => app()->getLocale(), 'id' => $postingan->id_postingan]) }}"
     data-post-user-name="{{ $postingan->user->nama_mahasiswa }}"
     class="bg-gradient-to-b from-gray-50 to-white dark:from-gray-950 dark:to-gray-900 min-h-screen py-8">
