                    ...
                    <div class="flex items-center justify-between">
                        ...
                        @if(auth()->check() && auth()->id() == $postingan->id_user)
                            <div class="relative group">
                                ...
                                <div class="hidden group-hover:block absolute right-0 bg-white dark:bg-gray-800 rounded-lg shadow-lg border border-gray-200 dark:border-gray-700 z-10">
                                    ...
                                    <form action="{{ route('postingan.destroy', $postingan->id_postingan) }}" method="POST" class="inline">
                                        @csrf @method('DELETE')
                                        <button type="button" onclick="if(confirm('Apakah Anda yakin?')) this.form.submit();"
                ...
                button.addEventListener('click', function(e) {
                    ...
                    .then(data => {
                        if (data.success) {
                            ...
                            const countText = document.querySelector('.like-count-text');
                            ...
                            countText.textContent = data.like_count + ' suka';
                        }
                    })
