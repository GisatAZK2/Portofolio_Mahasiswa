        ...
        <div class="p-8">
            ...
            <div class="mb-10 text-center md:text-left">
                <h1 class="text-3xl font-bold text-gray-800 dark:text-gray-200" data-translate="ttl"
                    data-translate-page="add_post">Buat Postingan Baru</h1>
                <p class="mt-2 text-gray-600 dark:text-gray-300" data-translate="desc" data-translate-page="add_post">
                    Bagikan pemikiran, cerita, atau pengalaman Anda dengan komunitas.</p>
            </div>
            ...
            <!-- Form -->
            <form method="POST" action="{{ route('postingan.store') }}" enctype="multipart/form-data" class="space-y-8">
                @csrf
                    ...
                    <div class="flex items-center justify-between mb-5">
                        ...
                        <button type="button" id="add-item"
                            ...
                            <span data-translate="add"
                                data-translate-page="add_post">{{autoTranslate('Tambah Item')}}</span>
                        </button>
                    </div>
...
<div class="pt-6 border-t border-gray-200 dark:border-gray-700">
    ...
    <script>
        ...
        // Toggle game fields
        document.getElementById('game_enabled').addEventListener('change', function (e) {
            document.getElementById('game_name').disabled = !this.checked;
            document.getElementById('game_thumbnail').disabled = !this.checked;
        });
