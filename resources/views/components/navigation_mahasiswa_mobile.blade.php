    ...
    @if(Auth::user()->role !== 'admin' && Auth::user()->role !== 'dosen')
        ...
        @php
            ...
            if (request()->routeIs('dashboard'))
                $activeTab = 'home';
            elseif (request()->routeIs('dashboard.me'))
                $activeTab = 'mydash';
            elseif (request()->routeIs('project.*'))
                $activeTab = 'project';
            elseif (request()->routeIs('sertifikat.*'))
                $activeTab = 'sertifikat';
            elseif (request()->routeIs('postingan.*'))
                $activeTab = 'post';
                ...
                <button type="button" onclick="toggleMobileProfile()"
                    ...
                    <div class="bnav-icon-wrap">
                        @if(Auth::user()->photo_profile)
                            <img src="{{ asset('storage/' . Auth::user()->photo_profile) }}" alt="foto"
                                class="bnav-avatar object-cover">
                        @else
                            <div
                                class="bnav-avatar bg-gradient-to-br from-blue-500 to-indigo-600 flex items-center justify-center text-white font-bold text-sm">
        ...
        <div id="mobile-fab-sheet"
            ...
            <div class="px-6 pb-2 pt-1">
                <p class="text-xs font-semibold text-gray-400 dark:text-gray-500 uppercase tracking-wider"
                    data-translate="tambah_baru" data-translate-page="mobile_nav">Tambah Baru</p>
            </div>
            ...
            <div class="px-4 pb-4 space-y-2">
                ...
                <a href="{{ route('project.index', ['locale' => app()->getLocale()]) }}" onclick="closeMobileFab()"
                    ...
                    <div class="flex-1">
                        <p class="text-sm font-semibold text-gray-800 dark:text-white" data-translate="project_mahasiswa_saya"
                            data-translate-page="mobile_nav">Project Saya</p>
                        <p class="text-xs text-gray-500 dark:text-gray-400" data-translate="lihat_semua_project"
                            data-translate-page="mobile_nav">Lihat semua project</p>
                    </div>
                ...
                <a href="{{ route('project.create', ['locale' => app()->getLocale()]) }}" onclick="closeMobileFab()"
                    ...
                    <div class="flex-1">
                        <p class="text-sm font-semibold text-gray-800 dark:text-white" data-translate="tambah_project_baru"
                            data-translate-page="mobile_nav">Tambah Project Baru</p>
                        <p class="text-xs text-gray-500 dark:text-gray-400" data-translate="upload_project_kamu"
                            data-translate-page="mobile_nav">Upload project kamu</p>
                    </div>
                    <svg class="w-4 h-4 text-gray-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5l7 7-7 7" />
                    </svg>
                ...
                <a href="{{ route('sertifikat.index', ['locale' => app()->getLocale()]) }}" onclick="closeMobileFab()"
                    ...
                    <div class="flex-1">
                        <p class="text-sm font-semibold text-gray-800 dark:text-white"
                            data-translate="sertifikat_mahasiswa_saya" data-translate-page="mobile_nav">Sertifikat Saya</p>
                        <p class="text-xs text-gray-500 dark:text-gray-400" data-translate="lihat_semua_sertifikat"
                            data-translate-page="mobile_nav">Lihat semua sertifikat</p>
                    </div>
                    <svg class="w-4 h-4 text-gray-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5l7 7-7 7" />
                    </svg>
                ...
                <a href="{{ route('sertifikat.create', ['locale' => app()->getLocale()]) }}" onclick="closeMobileFab()"
                    ...
                    <div class="flex-1">
                        <p class="text-sm font-semibold text-gray-800 dark:text-white" data-translate="tambah_sertifikat_mobile"
                            data-translate-page="mobile_nav">Tambah Sertifikat</p>
                        <p class="text-xs text-gray-500 dark:text-gray-400" data-translate="upload_sertifikatmu"
                            data-translate-page="mobile_nav">Upload sertifikatmu</p>
                    </div>
                    <svg class="w-4 h-4 text-gray-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5l7 7-7 7" />
                    </svg>
                ...
                <a href="{{ route('postingan.index', ['locale' => app()->getLocale()]) }}" onclick="closeMobileFab()"
                    ...
                    <div class="flex-1">
                        <p class="text-sm font-semibold text-gray-800 dark:text-white" data-translate="postingan"
                            data-translate-page="mobile_nav">Postingan</p>
                        <p class="text-xs text-gray-500 dark:text-gray-400" data-translate="lihat_semua_postingan"
                            data-translate-page="mobile_nav">Lihat semua postingan</p>
                    </div>
                    <svg class="w-4 h-4 text-gray-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5l7 7-7 7" />
                    </svg>
                ...
                <a href="{{ route('postingan.create', ['locale' => app()->getLocale()]) }}" onclick="closeMobileFab()"
                    ...
                    <div class="flex-1">
                        <p class="text-sm font-semibold text-gray-800 dark:text-white" data-translate="tambah_postingan_mobile"
                            data-translate-page="mobile_nav">Tambah Postingan</p>
                        <p class="text-xs text-gray-500 dark:text-gray-400" data-translate="bagikan_sesuatu"
                            data-translate-page="mobile_nav">Bagikan sesuatu</p>
                    </div>
                    <svg class="w-4 h-4 text-gray-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5l7 7-7 7" />
                    </svg>
        ...
        <div id="mobile-profile-sheet"
            ...
            <div class="flex items-center gap-3 px-6 py-4 border-b border-gray-100 dark:border-gray-800">
                ...
                <div class="flex-1 min-w-0">
                    <p class="text-sm font-semibold text-gray-800 dark:text-white truncate">
                        {{ Auth::user()->nama_mahasiswa ?? Auth::user()->name }}</p>
            ...
            <div class="px-4 py-3 space-y-1">
                <a href="{{ route('profile') }}" onclick="closeMobileProfile()"
                    ...
                    <span class="text-sm text-gray-700 dark:text-gray-200" data-translate="lihat_profil"
                        data-translate-page="sidebar">Lihat Profil</span>
                </a>
                ...
                <a href="{{ route('passkeys.index') }}" onclick="closeMobileProfile()"
                    ...
                    <span class="text-sm text-gray-700 dark:text-gray-200" data-translate="verifikasi_2_langkah"
                        data-translate-page="sidebar">Verifikasi 2 Langkah</span>
                </a>
                ...
                <button type="button" onclick="toggleMobileDarkMode()"
                    ...
                    <span class="text-sm text-gray-700 dark:text-gray-200 flex-1 text-left" data-translate="mode"
                        data-translate-page="sidebar">Dark Mode</span>
                    <div id="mobile-dark-toggle"
                        class="relative inline-block w-10 h-5 rounded-full bg-gray-200 dark:bg-blue-600 transition-colors duration-300">
                        <span
                            class="absolute left-0.5 top-0.5 w-4 h-4 bg-white rounded-full shadow transition-transform duration-300 dark:translate-x-5"></span>
                    </div>
                </button>
                ...
                <div class="flex items-center gap-3 px-4 py-3 rounded-xl">
                    ...
                    <span class="text-sm text-gray-700 dark:text-gray-200 flex-1" data-translate="bahasa"
                        data-translate-page="sidebar">Bahasa</span>
                ...
                <form method="POST" action="{{ route('logout') }}" class="m-0">
                    @csrf
                    <button type="submit"
                        class="w-full flex items-center gap-3 px-4 py-3 rounded-xl hover:bg-red-50 dark:hover:bg-red-900/20 transition">
                        <svg class="w-5 h-5 text-red-500" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                d="M17 16l4-4m0 0l-4-4m4 4H7m6 4v1a3 3 0 01-3 3H6a3 3 0 01-3-3V7a3 3 0 013-3h4a3 3 0 013 3v1" />
                        </svg>
                        <span class="text-sm text-red-600 dark:text-red-400 font-medium" data-translate="logout"
                            data-translate-page="sidebar">Logout</span>
                    </button>
                </form>
            </div>
            <div class="h-16"></div>
...
@guest
    <nav id="mobile-bottom-nav" class="lg:hidden fixed z-10600">
        <div class="bnav-bar">
            ...
            <a href="{{ route('project.project_user', ['locale' => app()->getLocale()]) }}"
                class="bnav-item {{ request()->routeIs('project.project_user') ? 'active' : '' }}">
                <div class="bnav-icon-wrap">
                    <svg fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                            d="M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z" />
                ...
                <span data-translate="project_mahasiswa" data-translate-page="sidebar">Project</span>
            </a>

            {{-- Tombol menu untuk guest (Login, Register, Dark Mode, Bahasa) --}}
            <button type="button" id="guest-menu-btn" class="bnav-item">
                <div class="bnav-icon-wrap">
                    <svg fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                            d="M16 7a4 4 0 11-8 0 4 4 0 018 0zM12 14a7 7 0 00-7 7h14a7 7 0 00-7-7z" />
                ...
                <span data-translate="akun" data-translate-page="mobile_nav">Akun</span>
            </button>
        </div>
    </nav>
    ...
    <div id="guest-sheet"
        ...
        <div class="px-6 pb-2 pt-1">
            <p class="text-xs font-semibold text-black dark:text-white uppercase tracking-wider" data-translate="menu_tamu"
                data-translate-page="mobile_nav">Menu Tamu</p>
        </div>
        ...
        <div class="px-4 pb-4 space-y-2">
            ...
            <a href="{{ route('login', ['locale' => app()->getLocale()]) }}"
                ...
                <div class="flex-1">
                    <p class="text-sm font-semibold text-gray-800 dark:text-white" data-translate="login"
                        data-translate-page="sidebar">Masuk</p>
                    <p class="text-xs text-gray-500 dark:text-gray-400" data-translate="login_to_account"
                        data-translate-page="profile">Login ke akun Anda</p>
                </div>
                <svg class="w-4 h-4 text-gray-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5l7 7-7 7" />
                </svg>
            ...
            @if(Route::has('register'))
                <a href="{{ route('register', ['locale' => app()->getLocale()]) }}"
                    ...
                    <div class="flex-1">
                        <p class="text-sm font-semibold text-gray-800 dark:text-white" data-translate="register"
                            data-translate-page="sidebar">Daftar</p>
                        <p class="text-xs text-gray-500 dark:text-gray-400" data-translate="create_account"
                            data-translate-page="profile">Buat akun baru</p>
                    </div>
                    <svg class="w-4 h-4 text-gray-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5l7 7-7 7" />
                    </svg>
