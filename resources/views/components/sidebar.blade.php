<aside id="sidebar" class="fixed inset-y-0 left-0 z-50 bg-gray-100 dark:bg-gray-900 dark:border-gray-800 border-r border-gray-200 shadow-xl
    ...
    <div class="px-6 py-6 mt-10 border-b border-gray-200 dark:border-gray-800 flex items-center justify-between shrink-0">
        <div class="flex-1 flex justify-center lg:justify-center">
            <div
                ...
                <img id="logo-zoom" class="cursor-pointer logo-zoom w-20 h-20 rounded-full object-cover transition-all duration-300"
    ...
    <nav class="flex-1 px-2 py-6 space-y-2 overflow-y-auto overflow-x-hidden">
        ...
        @guest
            ...
            <a href="{{ route('project.project_user') }}"
                ...
                <span
                    data-translate="project_mahasiswa" data-translate-page="sidebar"
                ...
                <div x-show="open && !{{ session('sidebar_collapsed', false) ? 'true' : 'false' }}"
                    ...
                    <a href="{{ route('project.index') }}"
                        class="flex items-center space-x-3 px-5 py-2.5 rounded-lg text-sm transition-all duration-200
                                  {{ request()->routeIs('project.index') ? ' text-blue-800 font-medium' : 'text-gray-700 dark:text-gray-200  hover:bg-blue-50 dark:hover:bg-gray-800 
    hover:text-blue-700 dark:hover:text-blue-400 ' }}">
                    ...
                    <a href="{{ route('project.create') }}"
                        class="flex items-center space-x-3 px-5 py-2.5 rounded-lg text-sm transition-all duration-200
                                  {{ request()->routeIs('project.create') ? ' text-blue-800 font-medium' : 'text-gray-700 dark:text-gray-200  hover:bg-blue-50 dark:hover:bg-gray-800 
    hover:text-blue-700 dark:hover:text-blue-400 ' }}">
                        <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        @auth
            ...
            <div class="space-y-1 relative" x-data="{ open: {{ request()->routeIs('sertifikat.*') ? 'true' : 'false' }} }">
                <button @click="open = !open"
                    class="w-full flex items-center space-x-3 px-4 py-3 rounded-xl transition-all duration-200 group relative
                               {{ request()->routeIs('sertifikat.*') ? 'bg-blue-600 text-white shadow-md' : 'text-gray-700 dark:text-gray-200  hover:bg-blue-50 dark:hover:bg-gray-800 
    hover:text-blue-700 dark:hover:text-blue-400 ' }}">
                ...
                <div x-show="open && !{{ session('sidebar_collapsed', false) ? 'true' : 'false' }}"
                    ...
                    <a href="{{ route('sertifikat.index') }}"
                        class="flex items-center space-x-3 px-5 py-2.5 rounded-lg text-sm transition-all duration-200
                              {{ request()->routeIs('sertifikat.index') ? ' text-blue-800 font-medium' : ' dark:text-gray-200 text-gray-700  hover:bg-blue-50 dark:hover:bg-gray-800 
    hover:text-blue-700 dark:hover:text-blue-400 ' }}">
                        <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                d="M4 6h16M4 12h16M4 18h7" />
                    ...
                    <a href="{{ route('sertifikat.create') }}"
                        class="flex items-center space-x-3 px-5 py-2.5 rounded-lg text-sm transition-all duration-200
                              {{ request()->routeIs('sertifikat.create') ? ' text-blue-800 font-medium' : ' dark:text-gray-200 text-gray-700  hover:bg-blue-50 dark:hover:bg-gray-800 
    hover:text-blue-700 dark:hover:text-blue-400 ' }}">
                        <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 4v16m8-8H4" />
                        </svg>
    ...
    <svg id="settingArrow"
        class="w-4 h-4 ml-auto transition-transform text-gray-500 dark:text-gray-400"
        fill="none" stroke="currentColor" viewBox="0 0 24 24">
        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
            d="M19 9l-7 7-7-7"/>
    </svg>
    ...
    <!-- FOOTER -->
    <div class="px-2 py-5 border-t border-gray-200 dark:border-gray-900 bg-gray-50 dark:bg-gray-800 shrink-0">
        @auth
            <a href="{{ route('profile') ?? '/profile' }}"
                class="block hover:bg-gray-100 dark:hover:bg-gray-800 rounded-lg dark:bg-gray-800 transition p-2 -mx-2 group relative">
        ...
        @else
            <div data-translate="login_prompt"
                        data-translate-page="sidebar" class="text-center text-sm text-gray-500 dark:text-gray-50 {{ session('sidebar_collapsed', false) ? 'lg:hidden' : '' }}">
            </div>
            <div class="mt-3 flex {{ session('sidebar_collapsed', false) ? 'lg:flex-col lg:space-y-2' : '' }} space-x-2">
                <a href="{{ route('login') }}"
                    ...
                    <span data-translate="login" data-translate-page="sidebar" class="{{ session('sidebar_collapsed', false) ? 'lg:hidden' : '' }}">Login</span>
                    @if(session('sidebar_collapsed', false))
                        ...
                        <span
                        data-translate="login" data-translate-page="sidebar"
                            class="absolute left-full ml-2 px-2 py-1 bg-gray-900 text-white text-sm rounded-md opacity-0 group-hover:opacity-100 pointer-events-none transition-opacity z-50 whitespace-nowrap hidden lg:block">
