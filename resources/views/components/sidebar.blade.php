<aside id="sidebar" class="fixed inset-y-0 left-0 z-50 w-70 bg-gray-100 dark:bg-gray-900 dark:border-gray-800 border-r border-gray-200 shadow-xl
    ...
    <!-- Logo -->
    <div
        class="px-6 py-6 mt-10 border-b border-gray-200 dark:border-gray-800 flex items-center justify-between shrink-0">
        <div class="flex-1 flex justify-center lg:justify-center">
            <div
                ...
                <img id="logo-zoom"
                    class="cursor-pointer w-20 h-20 rounded-full object-cover transition-all duration-300"
    ...
    <nav class="flex-1 px-2 py-6 space-y-2 overflow-y-auto overflow-x-hidden">
                ...
                <div x-data="{ open: {{ request()->routeIs('admin.users.*') ? 'true' : 'false' }} }" class="relative">
                    <button @click="open = !open"
                        ...
                        <div class="flex items-center space-x-3">
                            ...
                            <span data-translate="manajemen_users" data-translate-page="sidebar"
                                class="font-medium whitespace-nowrap {{ session('sidebar_collapsed') ? 'lg:hidden' : '' }}">
                ...
                <div x-data="{ open: {{ request()->routeIs('admin.angkatan.*') ? 'true' : 'false' }} }" class="relative">
                    <button @click="open = !open"
                        ...
                        <div class="flex items-center space-x-3">
                            ...
                            <span data-translate="manajemen_angkatan"
                                class="font-medium whitespace-nowrap {{ session('sidebar_collapsed') ? 'lg:hidden' : '' }}">
                                Manajemen Angkatan
                            </span>
                        </div>
                ...
                <div x-data="{ open: {{ request()->routeIs('admin.prodi.*') ? 'true' : 'false' }} }" class="relative">
                    <button @click="open = !open"
                        ...
                        <div class="flex items-center space-x-3">
                            ...
                            <span data-translate="manajemen_prodi" data-translate-page="sidebar" class="font-medium whitespace-nowrap {{ session('sidebar_collapsed') ? 'lg:hidden' : '' }}">
                            </span>
                        </div>
                        <!-- Arrow Icon - hanya tampil saat sidebar tidak collapsed -->
                        <svg x-show="!{{ session('sidebar_collapsed') ? 'true' : 'false' }}" :class="open ? 'rotate-180' : ''"
                    ...
                    @if(session('sidebar_collapsed'))
                        <span
                            class="absolute left-full ml-2 px-2 py-1 bg-gray-900 text-white text-sm rounded-md opacity-0 group-hover:opacity-100 pointer-events-none transition-opacity z-50 whitespace-nowrap hidden lg:block"
                            data-translate="manajemen_prodi" data-translate-page="sidebar">
                        </span>
                    @endif
                    <!-- Sub Menu (Dropdown Content) - hanya tampil saat sidebar tidak collapsed atau saat open di mobile -->
                    <div x-show="open && (!{{ session('sidebar_collapsed') ? 'true' : 'false' }} || window.innerWidth < 1024)"
                        ...
                        <a href="{{ route('admin.prodi.index') }}"
                            ...
                            <span data-translate="lihat_prodi" data-translate-page="admin"></span>
                        </a>
                        ...
                        <a href="{{ route('admin.prodi.create') }}"
                            ...
                            <span data-translate="tambah_prodi" data-translate-page="admin"></span>
                        </a>
                    </div>
                </div>
                ...
                <div x-data="{ open: {{ request()->routeIs('admin.keahlian.*') ? 'true' : 'false' }} }" class="relative">
                    <button @click="open = !open"
                        ...
                        <div class="flex items-center space-x-3">
                            ...
                            <span data-translate="manajemen_keahlian" data-translate-page="sidebar" class="font-medium whitespace-nowrap {{ session('sidebar_collapsed') ? 'lg:hidden' : '' }}">
                            </span>
                        </div>
                        <!-- Arrow Icon - hanya tampil saat sidebar tidak collapsed -->
                        <svg x-show="!{{ session('sidebar_collapsed') ? 'true' : 'false' }}" :class="open ? 'rotate-180' : ''"
                    ...
                    @if(session('sidebar_collapsed'))
                        <span
                            class="absolute left-full ml-2 px-2 py-1 bg-gray-900 text-white text-sm rounded-md opacity-0 group-hover:opacity-100 pointer-events-none transition-opacity z-50 whitespace-nowrap hidden lg:block"
                            data-translate="manajemen_keahlian" data-translate-page="sidebar">
                        </span>
                    @endif
                    <!-- Sub Menu (Dropdown Content) - hanya tampil saat sidebar tidak collapsed atau saat open di mobile -->
                    <div x-show="open && (!{{ session('sidebar_collapsed') ? 'true' : 'false' }} || window.innerWidth < 1024)"
                        ...
                        <a href="{{ route('admin.keahlian.index') }}"
                            ...
                            <span data-translate="lihat_keahlian" data-translate-page="admin"></span>
                        </a>
                        ...
                        <a href="{{ route('admin.keahlian.create') }}"
                            ...
                            <span data-translate="tambah_keahlian" data-translate-page="admin"></span>
                        </a>
                    </div>
                </div>
                ...
                <div x-data="{ open: {{ request()->routeIs('admin.projects.*') ? 'true' : 'false' }} }" class="relative">
                    <button @click="open = !open"
                        ...
                        <div class="flex items-center space-x-3">
                            ...
                            <span data-translate="manajemen_projects"
                                class="font-medium whitespace-nowrap {{ session('sidebar_collapsed') ? 'lg:hidden' : '' }}">
                                Manajemen Project
                            </span>
                        </div>
                ...
                <div x-data="{ open: {{ request()->routeIs('admin.sertifikat.*') ? 'true' : 'false' }} }" class="relative">
                    <button @click="open = !open"
                        ...
                        <div class="flex items-center space-x-3">
                            ...
                            <span data-translate="manajemen_sertifikat"
                                class="font-medium whitespace-nowrap {{ session('sidebar_collapsed') ? 'lg:hidden' : '' }}">
        ...
        @auth
            @if(Auth::user()->role === 'dosen')
                ...
                <div class="space-y-1 relative" x-data="{ open: {{ request()->routeIs('dosen.users.*') ? 'true' : 'false' }} }">
                    ...
                    <button @click="open = !open"
                        ...
                        <div class="flex items-center space-x-3">
                            ...
                            <!-- TEXT -->
                            <span data-translate="mhs_bbg" data-translate-page="dosen_sidebar"
                ...
                <div class="space-y-1 relative"
                    ...
                    <button @click="open = !open"
                        ...
                        <div class="flex items-center space-x-3">
                            ...
                            <!-- TEXT -->
                            <span data-translate="stk_bbg" data-translate-page="dosen_sidebar"
                                class="font-medium whitespace-nowrap {{ session('sidebar_collapsed', false) ? 'lg:hidden' : '' }}">
    ...
    <div class="group relative mt-auto mb-4 px-2">
        <button onclick="toggleDropdown('setting')"
            ...
            <svg id="settingArrow"
                class="w-4 h-4 transition-transform {{ session('sidebar_collapsed') ? 'lg:hidden' : '' }}" fill="none"
        ...
        @auth
            @if(Auth::user()->role === 'admin')
                <div class="block rounded-lg transition p-2 -mx-2 group relative cursor-default">
                    <div class="flex items-center space-x-3">
                        <div
                            class="w-10 h-10 rounded-full overflow-hidden border-2 border-white dark:border-gray-900 shadow-sm shrink-0">
                        ...
                        <div class="flex-1 min-w-0 {{ session('sidebar_collapsed', false) ? 'lg:hidden' : '' }}">
                            ...
                            <p class="text-xs text-gray-500 dark:text-gray-400 truncate">
                                {{ Auth::user()->email }}
                                <span
                                    class="ml-1 px-1.5 py-0.5 bg-blue-100 dark:bg-blue-900 text-blue-800 dark:text-blue-200 rounded-full text-[10px] font-semibold">
                                    Admin
                                </span>
                            </p>
                        </div>
                    ...
                    <div class="flex items-center space-x-3">
                        ...
                        <div class="flex-1 min-w-0 {{ session('sidebar_collapsed', false) ? 'lg:hidden' : '' }}">
                            ...
                            <p class="text-xs text-gray-500 dark:text-gray-400 truncate">
                                {{ Auth::user()->email }}
                                <span
                                    class="ml-1 px-1.5 py-0.5 bg-green-100 dark:bg-green-900 text-green-800 dark:text-green-200 rounded-full text-[10px] font-semibold">
                                    Dosen
                                </span>
                            </p>
                        </div>
                ...
                <a href="{{ route('profile') }}"
                    ...
                    <div class="flex items-center space-x-3">
                        <div
                            ...
                            @if(Auth::user()->photo_profile)
                                <img src="{{ asset('storage/' . Auth::user()->photo_profile) }}"
                                    alt="{{ Auth::user()->nama_mahasiswa ?? Auth::user()->name }}"
            ...
            <form method="POST" action="{{ route('logout') }}" class="mt-3">
                ...
                <button type="submit"
                    ...
                    <span class="{{ session('sidebar_collapsed', false) ? 'lg:hidden' : '' }}"
                        data-translate="logout">Logout</span>
                    @if(session('sidebar_collapsed', false))
                        <span
                            class="absolute left-full ml-2 px-2 py-1 bg-gray-900 text-white text-sm rounded-md opacity-0 group-hover:opacity-100 pointer-events-none transition-opacity z-50 whitespace-nowrap hidden lg:block">
                            Logout
