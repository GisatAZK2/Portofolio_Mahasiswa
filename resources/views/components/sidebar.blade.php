<aside id="sidebar"
    ...
    <nav class="flex-1 px-4 py-6 space-y-2 overflow-y-auto">
        ...
        <!-- Portfolio Dropdown (selalu tampil) -->
        <div class="space-y-1">
            <button onclick="toggleDropdown('portfolio')"
                    class="w-full flex items-center space-x-3 px-4 py-3 rounded-xl transition-all duration-200
                           {{ request()->routeIs('portofolio.*') ? 'bg-blue-600 text-white shadow-md' : 'text-gray-700 hover:bg-blue-50 hover:text-blue-700' }}">
                <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 11H5m14 0a2 2 0 012 2v6a2 2 0 01-2 2H5a2 2 0 01-2-2v-6a2 2 0 012-2m14 0V9a2 2 0 00-2-2M5 11V9a2 2 0 012-2m0 0V5a2 2 0 012-2h6a2 2 0 012 2v2M7 7h10"/>
                </svg>
                <span class="font-medium flex-1 text-left">Portfolio</span>
                <svg id="portfolioArrow" class="w-4 h-4 transition-transform duration-300 {{ request()->routeIs('portofolio.*') ? 'rotate-180' : '' }}"
                     fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 9l-7 7-7-7"/>
                </svg>
            </button>
            <div id="portfolioMenu" class="pl-5 space-y-1 {{ request()->routeIs('portofolio.*') ? '' : 'hidden' }} mt-1">
                ...
                <a href="{{ route('portofolio.create') }}"
                   class="flex items-center space-x-3 px-5 py-2.5 rounded-lg text-sm transition-all duration-200
                          {{ request()->routeIs('portofolio.create') ? 'bg-blue-100 text-blue-800 font-medium' : 'text-gray-700 hover:bg-blue-50 hover:text-blue-700' }}">
                    <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        <!-- Project Dropdown - Hanya tampil kalau sudah login -->
        @auth
        <div class="space-y-1">
        ...
        <!-- Learning Corners Dropdown - Hanya tampil kalau sudah login -->
        @auth
        <div class="space-y-1">
