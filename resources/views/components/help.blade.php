        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                    ...
                    <div class="divide-y divide-gray-100 dark:divide-gray-700" id="faqContainer">
                        <div class="faq-item py-3 transform transition-all duration-500 ease-in-out">
                            ...
                            <div class="faq-answer mt-1 overflow-hidden transition-all duration-500 ease-in-out" style="max-height: 0; opacity: 0;">
                                <p class="text-sm text-gray-600 dark:text-gray-400">Website ini digunakan untuk para mahasiswa untuk menampilkan portofolio mereka.</p>
                            </div>
                        </div>
                        <div class="faq-item py-3 transform transition-all duration-500 ease-in-out">
                            <h3 class="font-medium text-gray-800 dark:text-white text-sm cursor-pointer hover:text-blue-600 dark:hover:text-blue-400 transition-colors flex justify-between items-center">
                            ...
                            <div class="faq-answer mt-1 overflow-hidden transition-all duration-500 ease-in-out" style="max-height: 0; opacity: 0;">
                                <p class="text-sm text-gray-600 dark:text-gray-400">Klik tombol Daftar, isi formulir dengan data yang benar, lalu verifikasi email.</p>
                            </div>
                        </div>
                        ...
                        <div class="faq-item py-3 transform transition-all duration-500 ease-in-out">
                            ...
                            <div class="faq-answer mt-1 overflow-hidden transition-all duration-500 ease-in-out" style="max-height: 0; opacity: 0;">
                                <p class="text-sm text-gray-600 dark:text-gray-400">Klik "Lupa Password" pada halaman login, ikuti instruksi reset password.</p>
                            </div>
                        </div>
                        ...
                        <div class="faq-item py-3 transform transition-all duration-500 ease-in-out">
                            ...
                            <div class="faq-answer mt-1 overflow-hidden transition-all duration-500 ease-in-out" style="max-height: 0; opacity: 0;">
                                <p class="text-sm text-gray-600 dark:text-gray-400">Masuk ke akun, buka halaman Profil, klik Edit Profil.</p>
                            </div>
                        </div>
                        ...
                        <div class="faq-item py-3 transform transition-all duration-500 ease-in-out">
                            ...
                            <div class="faq-answer mt-1 overflow-hidden transition-all duration-500 ease-in-out" style="max-height: 0; opacity: 0;">
                                <p class="text-sm text-gray-600 dark:text-gray-400">Pastikan menggunakan Chrome/Safari terbaru, dan koneksi internet stabil.</p>
                            </div>
                        </div>
                        ...
                        <div class="faq-item py-3 transform transition-all duration-500 ease-in-out">
                            ...
                            <div class="faq-answer mt-1 overflow-hidden transition-all duration-500 ease-in-out" style="max-height: 0; opacity: 0;">
                                <p class="text-sm text-gray-600 dark:text-gray-400">Anda dapat menghubungi kami melalui email info@polmind.ac.id atau WhatsApp +62 821-1329-6897.</p>
                            </div>
                        </div>
                        <div class="faq-item py-3 transform transition-all duration-500 ease-in-out">
                            <h3 class="font-medium text-gray-800 dark:text-white text-sm cursor-pointer hover:text-blue-600 dark:hover:text-blue-400 transition-colors flex justify-between items-center">
                                Apakah bisa menghubungi para mahasiswa?
                                <svg class="w-4 h-4 text-gray-500 transition-transform duration-300 faq-icon" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 9l-7 7-7-7"></path>
                                </svg>
                            </h3>
                            <div class="faq-answer mt-1 overflow-hidden transition-all duration-500 ease-in-out" style="max-height: 0; opacity: 0;">
                                <p class="text-sm text-gray-600 dark:text-gray-400">Anda dapat menghubungi mahasiswa melalui email mereka atau dengan menghubungi admin untuk informasi mereka.</p>
                            </div>
                        </div>
                        <div class="faq-item py-3 transform transition-all duration-500 ease-in-out">
                            <h3 class="font-medium text-gray-800 dark:text-white text-sm cursor-pointer hover:text-blue-600 dark:hover:text-blue-400 transition-colors flex justify-between items-center">
                                Apa itu portofolio dan kenapa penting di website ini?
                                <svg class="w-4 h-4 text-gray-500 transition-transform duration-300 faq-icon" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 9l-7 7-7-7"></path>
                                </svg>
                            </h3>
                            <div class="faq-answer mt-1 overflow-hidden transition-all duration-500 ease-in-out" style="max-height: 0; opacity: 0;">
                                <p class="text-sm text-gray-600 dark:text-gray-400">Portofolio adalah kumpulan hasil karya atau proyek yang pernah Anda kerjakan. Portofolio membantu pihak luar melihat kemampuan dan keterampilan Anda.</p>
                            </div>
                        </div>
                        <div class="faq-item py-3 transform transition-all duration-500 ease-in-out">
                            <h3 class="font-medium text-gray-800 dark:text-white text-sm cursor-pointer hover:text-blue-600 dark:hover:text-blue-400 transition-colors flex justify-between items-center">
                                Bagaimana cara menambahkan portofolio?
                                <svg class="w-4 h-4 text-gray-500 transition-transform duration-300 faq-icon" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 9l-7 7-7-7"></path>
                                </svg>
                            </h3>
                            <div class="faq-answer mt-1 overflow-hidden transition-all duration-500 ease-in-out" style="max-height: 0; opacity: 0;">
                                <p class="text-sm text-gray-600 dark:text-gray-400">Masuk ke dashboard, pilih menu portofolio, lalu klik tombol tambah proyek atau tambah sertifikat dan isi informasi yang diperlukan seperti judul, deskripsi, dan file pendukung.</p>
                            </div>
                        </div>
                        <div class="faq-item py-3 transform transition-all duration-500 ease-in-out">
                            <h3 class="font-medium text-gray-800 dark:text-white text-sm cursor-pointer hover:text-blue-600 dark:hover:text-blue-400 transition-colors flex justify-between items-center">
                            ...
                            <div class="faq-answer mt-1 overflow-hidden transition-all duration-500 ease-in-out" style="max-height: 0; opacity: 0;">
                                <p class="text-sm text-gray-600 dark:text-gray-400">Teaching Factory (TeFa) adalah sistem pembelajaran berbasis proyek nyata, di mana mahasiswa mengerjakan proyek dari dunia industri sebagai bagian dari proses akademik.</p>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="space-y-4">
                <div class="bg-blue-50 dark:bg-blue-900/20 rounded-xl shadow-md p-5 text-center">
                    ...
                    <h3 class="font-semibold text-gray-800 dark:text-white">Butuh Bantuan?</h3>
                    <p class="text-sm text-gray-600 dark:text-gray-400 mt-1">Tim support siap membantu Anda</p>
                ...
                <div class="bg-white dark:bg-gray-800 rounded-xl shadow-md p-5">
                    <h3 class="font-semibold text-gray-800 dark:text-white mb-3">Informasi Lain</h3>
                    <div class="space-y-2">
