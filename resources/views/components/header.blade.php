    ...
    <div class="px-4 py-3 sm:px-6 lg:px-8">
        <div class="flex items-center justify-between gap-3">
            ...
            <div class="flex items-center gap-2 lg:hidden">
                ...
                @endauth
                @auth
                    <!-- User Guide Button (Mobile only) -->
                    <button id="userGuideButtonMobile"
                        class="lg:hidden text-gray-700 dark:text-gray-300 focus:outline-none p-2 hover:bg-gray-100 dark:hover:bg-gray-700 rounded-full transition-all"
                        title="Mulai Panduan">
