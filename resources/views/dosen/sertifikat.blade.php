    ...
    <div class="p-6 lg:p-8 dark:bg-gray-700 rounded-2xl">
        <div class="flex flex-col md:flex-row md:items-center md:justify-between mb-8 gap-4">
            ...
            <div class="flex gap-3">
                ...
                <a href="{{ route('dosen.sertifikat.create') }}"
                    ...
                    <span data-translate="add_stk" data-translate-page="dosen_stk">Tambah Sertifikat</span>
                </a>
            </div>
        </div>
            ...
            <form action="{{ route('dosen.sertifikat.index') }}" method="GET" id="filterForm">
                <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-6 gap-4">
                    ...
                    <div>
                        ...
                        <select name="status_pengajuan"
                            class="w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-lg focus:ring-indigo-500 focus:border-indigo-500 dark:bg-gray-800 dark:text-gray-100">
                            <option data-translate="all_stat" data-translate-page="dosen_stk" value="">Semua Status</option>
                ...
                <div class="flex justify-end mt-4 space-x-3">
                    ...
                    <button type="submit"
                        ...
                        <span data-translate="trp_filter" data-translate-page="dosen_stk">Terapkan Filter</span>
                    </button>
                </div>
            </form>
        </div>
        ...
        @else
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                                ...
                                @if($entry->link_sertifikat && $entry->status_pengajuan == 'Di Terima' && $entry->is_active == 1)
                                    <div class="mb-4">
                                        <a href="{{ asset('storage/' . $entry->link_sertifikat) }}" target="_blank"
                                            ...
                                            <span data-translate="see_stk" data-translate-page="dosen_stk"></span>Lihat Sertifikat
                                        </a>
                                    </div>
                                @endif
                                ...
                                <div class="flex flex-col space-y-2 mt-4">
                                    ...
                                    <div class="flex gap-3">
                                        ...
                                        <form class="delete-form {{ $canEdit ? 'flex-1' : 'w-full' }}"
                                            ...
                                            @csrf
                                            @method('DELETE')
                                            <button type="submit" onclick="return confirm('Hapus Sertifikat? Sertifikat ini akan dihapus permanen dan tidak bisa dikembalikan.')" data-translate="del" data-translate-page="dosen_stk"
                                                class="w-full inline-flex items-center justify-center gap-2 py-2.5 px-4 bg-red-600 text-white rounded-lg hover:bg-red-700 active:bg-red-800 transition font-medium shadow-sm hover:shadow-md dark:bg-red-600 dark:hover:bg-red-700 dark:active:bg-red-800">
                                                <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                                        d="M19 7l-.867 12.142A2 2 0 0116.138 21H7.862a2 2 0 01-1.995-1.858L5 7m5 4v6m4-6v6m1-10V4a1 1 0 00-1-1h-4a1 1 0 00-1 1v3M4 7h16" />
                                                </svg>
                ...
                {{-- Pagination --}}
                <div class="mt-8" data-pagination-group="dosen_sertifikats">
                    {{ $sertifikat->render('vendor.pagination.custom_ajax', ['groupName' => 'dosen_sertifikats']) }}
                </div>
