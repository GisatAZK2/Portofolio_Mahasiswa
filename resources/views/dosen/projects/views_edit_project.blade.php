...
@section('content')
    <div class="min-h-screen bg-gray-50 dark:bg-gray-950">
        <div class="p-4 md:p-8 max-w-7xl mx-auto">
            ...
            <form method="POST" action="{{ route('dosen.projects.update', ['id' => $project->id]) }}" class="space-y-6 md:space-y-7" id="projectForm" data-dosen-project-edit>
                @csrf
                @method('PUT')
    ...
    <div id="dosen-project-edit-data"
