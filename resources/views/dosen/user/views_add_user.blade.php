...
<div class="container mx-auto px-4 py-8">
    ...
    <div class="mb-8">
        ...
        <p class="text-gray-600 mt-2">Form tambah mahasiswa untuk dosen</p>
    </div>
    ...
    <div class="bg-white rounded-xl shadow-lg p-6 md:p-8 max-w-3xl mx-auto">
        <form method="POST" action="{{ route('dosen.users.StoreUser') }}" enctype="multipart/form-data">
            ...
            <!-- Informasi Dasar -->
            <div class="mb-8">
                <h2 class="text-xl font-semibold text-gray-800 mb-4 pb-2 border-b">Informasi Mahasiswa</h2>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div>
                        ...
                        <select name="jenis_kelamin" 
                                class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-colors @error('jenis_kelamin') border-red-500 @enderror">
                    ...
                    <div class="md:col-span-2">
                        ...
                        <div class="flex items-center space-x-6">
                            <div class="flex-shrink-0">
                                <img id="preview" src="https://via.placeholder.com/150" class="w-20 h-20 rounded-full object-cover border-2 border-gray-300">
                            </div>
                            <div class="flex-1">
                                <input type="file" 
                                       name="photo_profile" 
                                ...
                                <p class="mt-2 text-xs text-gray-500">Format: JPEG, PNG, JPG. Maks: 2MB</p>
                            </div>
                        </div>
                        @error('photo_profile')
                            <p class="mt-1 text-sm text-red-500">{{ $message }}</p>
