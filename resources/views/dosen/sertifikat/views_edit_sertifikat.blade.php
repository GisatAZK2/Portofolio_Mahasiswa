        ...
        <div class=" p-8">
            ...
            <div class="mb-8 text-center md:text-left">
                <div class="flex items-center gap-3 mb-2">
                    <h1 class="text-3xl font-bold text-gray-800 dark:text-gray-200" data-translate="ttl_form"
                        data-translate-page="dosen_stk_edit">Edit Sertifikat</h1>
                </div>
                <p class="mt-2 text-gray-600 dark:text-gray-300" data-translate="desc_form"
                    data-translate-page="dosen_stk_edit">Perbarui informasi sertifikat yang sudah kamu peroleh.</p>
            </div>
            ...
            @if ($errors->any())
                <div class="mb-8 p-5 bg-red-50 border border-red-200 text-red-700 rounded-xl">
                    <div class="flex items-center gap-2 mb-2">
                        ...
                        <span class="font-medium" data-translate="err" data-translate-page="dosen_stk_edit">Terdapat kesalahan
                            pada input:</span>
                    </div>
            ...
            <!-- Form -->
            <form method="POST" action="{{ route('dosen.sertifikat.update', ['id' => $sertifikat->id]) }}"
                ...
                <div>
                    <label for="nama_sertifikat" class="block text-sm dark:text-gray-100 font-medium text-gray-700 mb-2">
                        <span data-translate="nm_stk" data-translate-page="dosen_stk_edit">Nama Sertifikat</span> <span
                ...
                <div>
                    <label for="lembaga_penerbit" class="block text-sm dark:text-gray-100 font-medium text-gray-700 mb-2">
                        <span data-translate="lembaga" data-translate-page="lembaga"
                            data-translate-page="dosen_stk_edit">Lembaga Penerbit</span> <span class="text-red-500">*</span>
                    </label>
                ...
                <div>
                    <label for="tanggal_terbit" class="block text-sm font-medium dark:text-gray-100 text-gray-700 mb-2">
                        <span data-translate="tggl_terbit" data-translate-page="dosen_stk_edit">Tanggal Terbit</span> <span
                            class="text-red-500">*</span>
                    </label>
                            ...
                            <div class="flex items-center gap-3">
                                ...
                                <div>
                                    ...
                                    <a href="{{ Storage::url($sertifikat->link_sertifikat) }}" target="_blank"
                                        ...
                                        <span data-translate="see_file" data-translate-page="dosen_stk_edit">Lihat file saat
                                            ini</span>
                                    </a>
                                </div>
                            </div>
                            <button data-translate="change_file" data-translate-page="dosen_stk_edit" type="button"
                ...
                <div id="file-upload-section" class="{{ $sertifikat->link_sertifikat ? 'hidden' : '' }}">
                    <label data-translate="up_file_opt" data-translate-page="dosen_stk_edit" for="link_sertifikat"
                    ...
                    <div class="mt-1 flex justify-center px-6 pt-5 pb-6 border-2 border-gray-300 dark:border-gray-600 border-dashed rounded-lg hover:border-indigo-400 dark:hover:border-indigo-400 transition cursor-pointer"
                        ...
                        <div class="space-y-2 text-center">
                            ...
                            <div class="flex text-sm text-gray-600 dark:text-gray-400">
                                ...
                                <p class="pl-1" data-translate="or_drag" data-translate-page="dosen_stk_edit">atau drag and
                                    drop</p>
                            </div>
                            <p class="text-xs text-gray-500 dark:text-gray-400" id="file-name">
                                ...
                                @else
                                    <span data-translate="format_file" data-translate-page="dosen_stk_edit">PNG, JPG, GIF up to
                                        5MB</span>
                                @endif
                            </p>
                        </div>
                    ...
                    <p class="mt-2 text-xs text-gray-500 dark:text-gray-400 flex items-center gap-1">
                        ...
                        <span data-translate="allowed_format" data-translate-page="dosen_stk_edit">Format yang
                ...
                @if($sertifikat->link_sertifikat && preg_match('/\.(jpg|jpeg|png|gif)$/i', $sertifikat->link_sertifikat))
                    <div id="current-image-preview"
                        ...
                        <p class="text-sm font-medium text-gray-700 dark:text-gray-200 mb-2" data-translate="curr_file"
                            data-translate-page="dosen_stk_edit">File Saat Ini:</p>
                ...
                <div class="bg-blue-50 dark:bg-blue-900/30 border border-blue-200 dark:border-blue-800 rounded-lg p-4 mt-6">
                    <div class="flex">
                        ...
                        <div class="ml-3 flex-1">
                            <p class="text-sm text-blue-700 dark:text-blue-200" data-translate="uped_file"
                                data-translate-page="dosen_stk_edit">
                ...
                <div class="flex justify-end gap-4 pt-8 border-t border-gray-200">
                    ...
                    <button type="submit"
                        ...
                        data-translate="upd_stk" data-translate-page="dosen_stk_edit">
                        <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 13l4 4L19 7" />
                        </svg>
                        <span>Update Sertifikat</span>
                    </button>
                </div>
            </form>
        </div>
