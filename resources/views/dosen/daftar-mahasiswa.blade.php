    ...
    <div class="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
        ...
        <div class="bg-white dark:bg-gray-800 rounded-lg shadow p-6">
            <div class="flex items-center">
                ...
                <div class="ml-4">
                    <p class="text-gray-500 dark:text-gray-400">Total Mahasiswa Bimbingan</p>
        ...
        <div class="bg-white dark:bg-gray-800 rounded-lg shadow p-6">
            <div class="flex items-center">
                ...
                <div class="ml-4">
                    <p class="text-gray-500 dark:text-gray-400">Menunggu Persetujuan</p>
                    <p class="text-2xl font-semibold">{{ App\Models\User::where('role', 'mahasiswa')
                        ->where('id_jurusan', auth()->user()->id_jurusan)
                        ->where('id_angkatan', auth()->user()->id_angkatan)
                        ->where('id_keahlian', auth()->user()->id_keahlian)
        ...
        <div class="bg-white dark:bg-gray-800 rounded-lg shadow p-6">
            <div class="flex items-center">
                ...
                <div class="ml-4">
                    ...
                    <p class="text-2xl font-semibold">{{ App\Models\Project::whereHas('user', function($q) {
            ...
            <div class="space-y-3">
                ...
                <a href="{{ route('dosen.projects.index') }}" 
                   class="block p-3 bg-green-50 dark:bg-gray-700 rounded-lg hover:bg-green-100 dark:hover:bg-gray-600">
                    <span class="font-medium">Kelola Projects</span>
                    <p class="text-sm text-gray-600 dark:text-gray-400">Lihat dan validasi project mahasiswa</p>
                </a>
                <a href="{{ route('dosen.sertifikat.index') }}" 
                   class="block p-3 bg-purple-50 dark:bg-gray-700 rounded-lg hover:bg-purple-100 dark:hover:bg-gray-600">
                    <span class="font-medium">Kelola Sertifikat</span>
                    <p class="text-sm text-gray-600 dark:text-gray-400">Lihat dan validasi sertifikat mahasiswa</p>
                </a>
            </div>
        </div>
        ...
        <div class="bg-white dark:bg-gray-800 rounded-lg shadow p-6">
            ...
            <div class="space-y-3">
                <div class="p-3 bg-gray-50 dark:bg-gray-700 rounded-lg">
                    <p class="text-sm">
                        <span class="font-medium">Jurusan:</span> {{ auth()->user()->jurusan->nama_jurusan ?? '-' }}
                    </p>
                    <p class="text-sm">
                        <span class="font-medium">Angkatan:</span> {{ auth()->user()->angkatan->tahun ?? '-' }}
                    </p>
                    <p class="text-sm">
                        <span class="font-medium">Keahlian:</span> {{ auth()->user()->keahlian->nama_keahlian ?? '-' }}
                    </p>
                </div>
            </div>
        </div>
