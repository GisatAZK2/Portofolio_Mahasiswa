...
<div class="min-h-screen bg-gray-50 dark:bg-gray-900 py-8 px-4 sm:px-6 lg:px-8 transition-colors duration-200">
    <div class="max-w-7xl mx-auto">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6">
            ...
            <div class="group relative bg-white dark:bg-gray-800 rounded-2xl border border-gray-200 dark:border-gray-700 overflow-hidden hover:shadow-xl transition-all duration-300 hover:-translate-y-1">
                ...
                <div class="relative h-24 bg-gradient-to-r from-blue-500 to-indigo-600 dark:from-blue-600 dark:to-indigo-700 px-6 pt-6">
                    ...
                    <div class="absolute -bottom-10 left-6 z-10">
                        ...
                        @else
                            <div class="w-20 h-20 rounded-xl bg-white dark:bg-gray-700 border-4 border-white dark:border-gray-800 shadow-lg flex items-center justify-center">
                ...
                <div class="pt-12 px-6 pb-6">
                    ...
                    <div class="space-y-2 text-sm mb-4">
                        ...
                        <div class="flex items-center text-gray-600 dark:text-gray-300">
                            ...
                            <a href="mailto:{{ $user->email }}" class="hover:underline truncate" title="{{ $user->email }}">
                                {{ $user->email }}
                            </a>
                        </div>
                        @endif
                    ...
                    <!-- Actions -->
                    <div class="flex items-center justify-end gap-2 mt-4 pt-2 border-t border-gray-100 dark:border-gray-700">
            ...
            <div class="col-span-full">
                <div class="bg-white dark:bg-gray-800 rounded-2xl border border-gray-200 dark:border-gray-700 p-12 text-center">
                    ...
                    <p class="text-sm text-gray-500 dark:text-gray-400 mb-4">Mulai dengan menambahkan pengguna pertama Anda</p>
                    <a href="{{ route('admin.users.ViewCreate') }}" class="inline-flex items-center px-4 py-2 bg-blue-600 hover:bg-blue-700 text-white text-sm font-medium rounded-lg transition-colors">
...
<!-- Modal Update Status -->
<div id="updateModal" class="fixed inset-0 bg-gray-900/50 dark:bg-gray-900/80 hidden overflow-y-auto h-full w-full z-50 transition-opacity duration-300">
...
<div id="deleteModal" class="fixed inset-0 bg-gray-900/50 dark:bg-gray-900/80 hidden overflow-y-auto h-full w-full z-50 transition-opacity duration-300">
    <div class="relative top-20 mx-auto p-5 w-full max-w-md">
        <div class="relative bg-white dark:bg-gray-800 rounded-2xl shadow-xl">
            <div class="p-6">
                ...
                <p class="text-sm text-gray-500 dark:text-gray-400 text-center mb-4">
                    Apakah Anda yakin ingin menghapus pengguna <span id="deleteUserName" class="font-medium text-gray-900 dark:text-white"></span>?
...
<!-- Loading Indicator -->
<div id="loadingOverlay" class="fixed inset-0 bg-gray-900/50 dark:bg-gray-900/80 hidden items-center justify-center z-[100]">
