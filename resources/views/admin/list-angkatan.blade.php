        ...
        <table class="min-w-full bg-white dark:bg-gray-800">
            ...
            <tbody class="divide-y divide-gray-200 dark:divide-gray-700">
                ...
                <tr class="hover:bg-gray-50 dark:hover:bg-gray-700">
                    <td class="px-6 py-4">
                        <input type="checkbox" name="selected[]" value="{{ $angkatan->id }}" class="item-checkbox rounded text-blue-600 focus:ring-blue-500" onchange="updateSelectedIds()">
                    </td>
                    <td class="px-6 py-4 dark:text-white">{{ $index + 1 }}</td>
                    <td class="px-6 py-4 dark:text-white font-medium">{{ $angkatan->nama_angkatan }}</td>
                    <td class="px-6 py-4 dark:text-white">{{ \Carbon\Carbon::parse($angkatan->tahun_masuk)->format('d/m/Y') }}</td>
        ...
        <div class="bg-white dark:bg-gray-700 rounded-lg shadow p-4 border border-gray-200 dark:border-gray-600">
            ...
            <div class="space-y-2 mb-4">
                ...
                <div class="flex justify-between items-center">
                    ...
                    <span class="text-sm dark:text-white">{{ \Carbon\Carbon::parse($angkatan->tahun_masuk)->format('d/m/Y') }}</span>
                </div>
                <div class="flex justify-between items-center">
