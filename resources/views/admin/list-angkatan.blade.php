...
@section('content')
            ...
            <div class="flex flex-wrap gap-2 w-full sm:w-auto">
                <form id="bulkDeleteForm" action="{{ route('admin.angkatan.bulk-destroy', ['locale' => app()->getLocale()]) }}" method="POST" class="inline">
                    ...
                    <button type="button" onclick="confirmBulkDelete()"
                        ...
                        <span class="hidden sm:inline" data-translate="delete_selected"
                            data-translate-page="project_detail">Hapus Terpilih</span>
                ...
                <a href="{{ route('admin.angkatan.create') }}"
                    ...
                    <span class="hidden sm:inline" data-translate="tambah_angkatan" data-translate-page="admin">Tambah
                        Angkatan</span>
                ...
                <thead>
                    <tr class="bg-gray-100 dark:bg-gray-700">
                        ...
                        <th class="px-6 py-3 text-left text-xs font-medium text-gray-500 dark:text-gray-300 uppercase tracking-wider"
                            data-translate="no_agkt" data-translate-page="admin">No</th>
                        <th class="px-6 py-3 text-left text-xs font-medium text-gray-500 dark:text-gray-300 uppercase tracking-wider"
                            data-translate="nm_agkt" data-translate-page="admin">Nama Angkatan</th>
                        <th class="px-6 py-3 text-left text-xs font-medium text-gray-500 dark:text-gray-300 uppercase tracking-wider"
                            data-translate="thn_agkt" data-translate-page="admin">Tahun Masuk</th>
                        <th class="px-6 py-3 text-left text-xs font-medium text-gray-500 dark:text-gray-300 uppercase tracking-wider"
                ...
                <tbody class="divide-y divide-gray-200 dark:divide-gray-700">
                    @forelse($angkatans as $index => $angkatan)
                        <tr class="hover:bg-gray-50 dark:hover:bg-gray-700">
                            <td class="px-6 py-4">
                                <input type="checkbox" name="selected[]" value="{{ $angkatan->id }}"
                ...
                <div class="bg-white dark:bg-gray-700 rounded-lg shadow p-4 border border-gray-200 dark:border-gray-600">
                    ...
                    <div class="space-y-2 mb-4">
                        <div class="flex justify-between items-center">
                            <span class="text-sm font-medium text-gray-500 dark:text-gray-400">Nama Angkatan:</span>
                            <span class="text-sm font-semibold dark:text-white">{{ $angkatan->nama_angkatan }}</span>
                        </div>
                        <div class="flex justify-between items-center">
                            <span class="text-sm font-medium text-gray-500 dark:text-gray-400">Tahun Masuk:</span>
                            <span
                                class="text-sm dark:text-white">{{ \Carbon\Carbon::parse($angkatan->tahun_masuk)->format('d/m/Y') }}</span>
                        </div>
                        <div class="flex justify-between items-center">
                            <span class="text-sm font-medium text-gray-500 dark:text-gray-400">Tahun Keluar:</span>
    ...
    <div id="deleteModal" class="fixed inset-0 bg-gray-600/50 hidden overflow-y-auto h-full w-full z-50">
        <div class="relative top-20 mx-auto p-5 border w-11/12 sm:w-96 shadow-lg rounded-md bg-white dark:bg-gray-800">
            <div class="mt-3 text-center">
                ...
                <h3 class="text-lg leading-6 font-medium text-gray-900 dark:text-white mb-2">Hapus Angkatan</h3>
    ...
    Swal.fire({
       ...
       // Open edit modal
        function openEditModal(angkatan) {
            ...
            document.getElementById('edit_keluar').value = angkatan.tahun_keluar
                ? angkatan.tahun_keluar.split(' ')[0]
                : '';
