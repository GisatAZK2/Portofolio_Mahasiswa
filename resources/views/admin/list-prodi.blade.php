...
@section('content')
    <div class="bg-white dark:bg-gray-800 rounded-lg shadow p-4 sm:p-6" data-page-info="popup.admin_mange_prodi">
        <!-- Header -->
        <div class="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 mb-6">
            ...
            <div class="flex flex-wrap gap-2 w-full sm:w-auto">
                ...
                <button type="button" onclick="confirmBulkDeleteProdi()"
                ...
                <thead>
                    <tr class="bg-gray-100 dark:bg-gray-700">
                        <th class="px-6 py-3 text-left">
                            <input type="checkbox" onclick="toggleAllProdi(this)"
                        ...
                        <tr class="hover:bg-gray-50 dark:hover:bg-gray-700">
                            ...
                            <td class="px-6 py-4">
                                <div class="flex space-x-3">
                                    ...
                                    <button onclick="openEditModalProdi({{ json_encode($jurusan) }})"
                                    ...
                                    <button onclick="handleDeleteProdi({{ $jurusan->id_jurusan }}, '{{ addslashes($jurusan->nama_jurusan) }}')"
