        ...
        <div class="max-w-4xl mx-auto">
            ...
            <div class="mb-5 px-4 py-3 rounded-xl bg-blue-50 dark:bg-blue-900/20 border border-blue-100 dark:border-blue-800 flex items-start gap-3">
                ...
                <p class="text-sm text-blue-700 dark:text-blue-300">
                    Edit informasi user yang sudah ada. Perbarui nama, username, email, atau status sesuai kebutuhan.
                </p>
            </div>
            ...
            <div class="bg-white dark:bg-gray-800 rounded-2xl shadow-sm border border-gray-100 dark:border-gray-700 overflow-hidden">
                ...
                <form action="{{ route('admin.users.edit', ['id' => $user->id]) }}" method="POST" enctype="multipart/form-data">
                    ...
                    {{-- Hidden role field (readonly, passed as hidden) --}}
                    ...
                    <div class="p-6">
                        ...
                        <div class="mb-8">
                            <div class="flex items-center gap-2 mb-4">
                                ...
                                <h2 class="text-sm font-semibold text-gray-700 dark:text-gray-300 uppercase tracking-wider">Informasi Dasar</h2>
                            </div>
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-5">
                                ...
                                <div>
                                    <label for="nama_mahasiswa"
                                        ...
                                        Nama Lengkap <span class="text-red-500 ml-0.5">*</span>
                                    </label>
                                ...
                                <div>
                                    <label for="username"
                                        class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1.5">
                                        Username <span class="text-red-500 ml-0.5">*</span>
                                    </label>
                                    <div class="relative">
                                    ...
                                    <p class="mt-1 text-xs text-gray-400">Hanya huruf, angka, dan underscore (_)</p>
                                    @error('username')
                        ...
                        <div class="mb-8">
                            <div class="flex items-center gap-2 mb-4">
                                ...
                                <h2 class="text-sm font-semibold text-gray-700 dark:text-gray-300 uppercase tracking-wider">Informasi Tambahan</h2>
                            </div>
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-5">
                                ...
                                {{-- NIM (mahasiswa only) --}}
                                <div id="nimField"
                                    style="{{ $user->role !== 'mahasiswa' ? 'display: none;' : '' }}">
                                    <label for="nim"
                                        class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1.5">
                                        NIM <span class="text-red-500 ml-0.5">*</span>
                                    </label>
                                    <div class="relative">
                                        <span class="absolute left-3 top-1/2 -translate-y-1/2 text-gray-400 text-sm">
                                ...
                                <div id="tanggalLahirField"
                                    style="{{ !in_array($user->role, ['mahasiswa', 'dosen']) ? 'display: none;' : '' }}">
                                ...
                                <div id="jurusanField"
                                    ...
                                    <label for="id_jurusan"
                                        class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1.5">
                                        Jurusan <span class="text-red-500 ml-0.5">*</span>
                                    </label>
                                    <div class="relative">
                                        <span class="absolute left-3 top-1/2 -translate-y-1/2 text-gray-400 text-sm">
                                        ...
                                        <select name="id_jurusan" id="id_jurusan"
                                            class="w-full pl-9 pr-4 py-2.5 text-sm border border-gray-200 dark:border-gray-600 rounded-xl focus:ring-2 focus:ring-blue-500 focus:border-transparent dark:bg-gray-700 dark:text-white transition @error('id_jurusan') border-red-400 @enderror"
                                ...
                                {{-- Bidang Keahlian (mahasiswa & dosen) --}}
                                <div id="keahlianField"
                                    style="{{ !in_array($user->role, ['mahasiswa', 'dosen']) ? 'display: none;' : '' }}">
                                    <label for="id_keahlian"
                                        class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1.5">
                                        Bidang Keahlian <span class="text-red-500 ml-0.5">*</span>
                                    </label>
                                    <div class="relative">
                                        <span class="absolute left-3 top-1/2 -translate-y-1/2 text-gray-400 text-sm">
                                        ...
                                        <select name="id_keahlian" id="id_keahlian"
                                            class="w-full pl-9 pr-4 py-2.5 text-sm border border-gray-200 dark:border-gray-600 rounded-xl focus:ring-2 focus:ring-blue-500 focus:border-transparent dark:bg-gray-700 dark:text-white transition @error('id_keahlian') border-red-400 @enderror"
                                            {{ in_array($user->role, ['mahasiswa', 'dosen']) ? 'required' : 'disabled' }}>
                                            <option value="">Pilih Keahlian</option>
                                            @foreach($keahlians as $keahlian)
                                                <option value="{{ $keahlian->id_keahlian }}"
                                                    {{ old('id_keahlian', $user->id_keahlian) == $keahlian->id_keahlian ? 'selected' : '' }}>
                                ...
                                {{-- Angkatan (mahasiswa & dosen) --}}
                                <div id="angkatanField"
                                    style="{{ !in_array($user->role, ['mahasiswa', 'dosen']) ? 'display: none;' : '' }}">
                                    <label for="id_angkatan"
                                        class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1.5">
                                        Angkatan <span class="text-red-500 ml-0.5">*</span>
                                    </label>
                                    <div class="relative">
                                        <span class="absolute left-3 top-1/2 -translate-y-1/2 text-gray-400 text-sm">
                                        ...
                                        <select name="id_angkatan" id="id_angkatan"
                                            class="w-full pl-9 pr-4 py-2.5 text-sm border border-gray-200 dark:border-gray-600 rounded-xl focus:ring-2 focus:ring-blue-500 focus:border-transparent dark:bg-gray-700 dark:text-white transition @error('id_angkatan') border-red-400 @enderror"
                                            {{ in_array($user->role, ['mahasiswa', 'dosen']) ? 'required' : 'disabled' }}>
                                            <option value="">Pilih Angkatan</option>
                                            @foreach($angkatans as $angkatan)
                                                <option value="{{ $angkatan->id }}"
                                                    {{ old('id_angkatan', $user->id_angkatan) == $angkatan->id ? 'selected' : '' }}>
                        ...
                        <div class="mb-8">
                            <div class="flex items-center gap-2 mb-4">
                                ...
                                <h2 class="text-sm font-semibold text-gray-700 dark:text-gray-300 uppercase tracking-wider">Status</h2>
                            </div>
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-5">
                                ...
                                <div>
                                    <label for="status_pengajuan"
                                        class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1.5">
                                        Status Pengajuan <span class="text-red-500 ml-0.5">*</span>
                                    </label>
                                    <select name="status_pengajuan" id="status_pengajuan"
                                        ...
                                        <option value="Di Terima"
                                            {{ old('status_pengajuan', $user->status_pengajuan) == 'Di Terima' ? 'selected' : '' }}>Di Terima</option>
                                        <option value="Di Tolak"
                                            {{ old('status_pengajuan', $user->status_pengajuan) == 'Di Tolak' ? 'selected' : '' }}>Di Tolak</option>
                                    </select>
                                ...
                                <div>
                                    <label for="is_active"
                                        class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1.5">
                                        Status Akun <span class="text-red-500 ml-0.5">*</span>
                                    </label>
                                    <select name="is_active" id="is_active"
                                        ...
                                        required>
                                        <option value="1"
                                            {{ old('is_active', $user->is_active) == 1 ? 'selected' : '' }}>Aktif</option>
                                        <option value="0"
                                            {{ old('is_active', $user->is_active) == 0 ? 'selected' : '' }}>Non Aktif</option>
                                    </select>
                                    @error('is_active')
                                        <p class="mt-1.5 text-xs text-red-500 flex items-center gap-1">
                                            <i class="fas fa-circle-exclamation"></i> {{ $message }}
                        ...
                        <div class="mb-8">
                            <div class="flex items-center gap-2 mb-4">
                                ...
                                <h2 class="text-sm font-semibold text-gray-700 dark:text-gray-300 uppercase tracking-wider">Password</h2>
                            </div>
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-5">
                                ...
                                <div>
                                    ...
                                    <div class="mt-2 p-3 bg-amber-50 dark:bg-amber-900/20 rounded-xl border border-amber-100 dark:border-amber-800/50">
                                        <p class="text-xs font-semibold text-amber-800 dark:text-amber-300 mb-1.5">Syarat Password:</p>
                                        <ul class="space-y-1">
                                            ...
                                            <li class="flex items-center gap-2 text-xs text-amber-700 dark:text-amber-400" id="hint-upper">
                                                ...
                                                <span>Harus ada huruf besar (A-Z)</span>
                                            </li>
                        ...
                        <div class="mb-2">
                            <div class="flex items-center gap-2 mb-4">
                                ...
                                <h2 class="text-sm font-semibold text-gray-700 dark:text-gray-300 uppercase tracking-wider">Foto Profil</h2>
                            </div>
                                    ...
                                    <label for="photo_profile"
                                        ...
                                        <div class="flex flex-col items-center gap-1.5 text-center px-4">
                                            ...
                                            <p class="text-xs text-gray-500 dark:text-gray-400">
                                                <span class="font-medium text-blue-500">Upload File</span>
                                                <span> atau drag &amp; drop</span>
                                            </p>
                                            <p class="text-[11px] text-gray-400">Format: JPEG, PNG, JPG. Maks: 2MB</p>
                                        </div>
