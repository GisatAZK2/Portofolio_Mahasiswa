...
@section('content')
    <div class="bg-white dark:bg-gray-800 rounded-lg shadow p-4 sm:p-6" data-page-info="popup.admin_mange_keahlian">
        <!-- Header -->
        <div class="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 mb-6">
            ...
            <div class="flex flex-wrap gap-2 w-full sm:w-auto">
                ...
                <button type="button" onclick="confirmBulkDeleteKeahlian()"
                ...
                <thead>
                    <tr class="bg-gray-100 dark:bg-gray-700">
                        <th class="px-6 py-3 text-left">
                            <input type="checkbox" onclick="toggleAllKeahlian(this)"
                        ...
                        <tr class="hover:bg-gray-50 dark:hover:bg-gray-700">
                            ...
                            <td class="px-6 py-4">
                                <div class="flex space-x-3">
                                    ...
                                    <button onclick="openEditModalKeahlian({{ json_encode($keahlian) }})"
                                    ...
                                    <button onclick="handleDeleteKeahlian({{ $keahlian->id_keahlian }}, '{{ addslashes($keahlian->nama_keahlian) }}')"
            ...
            <div class="mt-3">
                ...
                <form id="editForm" method="POST">
                    ...
                    <div class="flex flex-col sm:flex-row justify-end space-y-2 sm:space-y-0 sm:space-x-2">
                        <button type="button" onclick="closeModalKeahlian()"
        ...
        <div class="relative top-20 mx-auto p-5 border w-11/12 sm:w-96 shadow-lg rounded-md bg-white dark:bg-gray-800">
            <div class="mt-3 text-center">
                ...
                <div class="flex flex-col sm:flex-row justify-center space-y-2 sm:space-y-0 sm:space-x-2">
                    <button onclick="closeDeleteModalKeahlian()"
                        class="px-4 py-2 bg-gray-300 text-gray-700 rounded-lg hover:bg-gray-400 w-full sm:w-auto"
                        data-translate="cancel" data-translate-page="admin">Batal</button>
