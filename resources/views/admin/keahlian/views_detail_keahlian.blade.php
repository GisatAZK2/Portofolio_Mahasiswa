...
@section('content')
    ...
    <div class="min-h-screen bg-gray-50 dark:bg-gray-950 py-8 px-4 sm:px-6 lg:px-8" data-page-info="popup.admin_detail_keahlian">
        <div class="max-w-7xl mx-auto">
                ...
                <div class="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
                    <div>
                        ...
                        <p class="mt-2 text-gray-600 dark:text-gray-400">
                            {{ $keahlian->nama_keahlian ?? 'Keahlian' }}
                        </p>
                    </div>
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 gap-6 mb-10">
                <div class="bg-white dark:bg-gray-800 rounded-xl shadow-md p-6 border border-gray-100 dark:border-gray-700">
                    <div class="flex items-center gap-3 mb-3">
                        ...
                        <h3 class="text-sm font-medium text-gray-500 dark:text-gray-400" data-translate="nama_keahlian_label" data-translate-page="admin">Nama Keahlian</h3>
                    </div>
                    <p class="text-2xl font-bold text-gray-900 dark:text-white">{{ $keahlian->nama_keahlian }}</p>
                </div>
                ...
                <div class="bg-white dark:bg-gray-800 rounded-xl shadow-md p-6 border border-gray-100 dark:border-gray-700">
                    <div class="flex items-center gap-3 mb-3">
                        ...
                        <h3 class="text-sm font-medium text-gray-500 dark:text-gray-400" data-translate="total_mahasiswa" data-translate-page="admin">Total Mahasiswa</h3>
                    </div>
                    <p class="text-2xl font-bold text-gray-900 dark:text-white">{{ $keahlian->users_count ?? 0 }}</p>
                </div>
            </div>
            ...
            <div class="grid grid-cols-1 sm:grid-cols-3 gap-6 mb-10">
                <div class="bg-gradient-to-br from-blue-500 to-blue-600 rounded-xl shadow-lg p-6 text-white">
                    <div class="flex items-center justify-between">
                        <div>
                            <p class="text-sm opacity-90" data-translate="ttl_mhs" data-translate-page="project_create">Total Mahasiswa</p>
                            <p class="text-4xl font-bold mt-2">{{ $keahlian->users_count ?? 0 }}</p>
                        </div>
                ...
                <div class="bg-gradient-to-br from-green-500 to-green-600 rounded-xl shadow-lg p-6 text-white">
                    <div class="flex items-center justify-between">
                        <div>
                            <p class="text-sm opacity-90" data-translate="aktf" data-translate-page="project_create">Aktif</p>
                            <p class="text-4xl font-bold mt-2">{{ $keahlian->users->where('is_active', true)->count() }}</p>
                        </div>
                        <div class="w-12 h-12 bg-white/20 rounded-lg flex items-center justify-center">
                            <svg class="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z" />
                ...
                <div class="bg-gradient-to-br from-red-500 to-red-600 rounded-xl shadow-lg p-6 text-white">
                    <div class="flex items-center justify-between">
                        <div>
                            <p class="text-sm opacity-90" data-translate="tdk_aktf" data-translate-page="project_create">Tidak Aktif</p>
                            <p class="text-4xl font-bold mt-2">{{ $keahlian->users->where('is_active', false)->count() }}</p>
                        </div>
                        <div class="w-12 h-12 bg-white/20 rounded-lg flex items-center justify-center">
                            <svg class="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <div class="bg-white dark:bg-gray-800 rounded-xl shadow-md border border-gray-100 dark:border-gray-700 overflow-hidden">
                <div class="p-6 border-b border-gray-100 dark:border-gray-700">
                    <h2 class="text-xl font-semibold text-gray-900 dark:text-white" data-translate="daftar_mahasiswa" data-translate-page="admin">Daftar Mahasiswa</h2>
                </div>
                    ...
                    <div class="flex flex-col sm:flex-row gap-4">
                        ...
                        <div class="flex gap-3">
                            <button type="button" onclick="resetFiltersMahasiswa()"
                                ...
                                data-translate="rst_flt" data-translate-page="project_create">
                                Reset
                            </button>
    ...
    <script>
        window.__PAGE_DATA__ = {
            allMahasiswa: {!! json_encode($keahlian->users->map(function ($m) {
                return [
                    'id' => $m->id,
