        ...
        <form action="{{ route('admin.angkatan.store') }}" method="POST" class="space-y-6">
            ...
            <div>
                <label for="nama_angkatan" class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-2">
                    <span data-translate="nm_agkt_kcl" data-translate-page="admin">Nama Angkatan</span> <span
                ...
                <input type="text" name="nama_angkatan" id="nama_angkatan" value="{{ old('nama_angkatan') }}"
                    ...
                    placeholder="Contoh: Angkatan 2020" required>
                @error('nama_angkatan')
            ...
            <div>
                <label for="tahun_masuk" class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-2">
                    <span data-translate="thn_agkt_kcl" data-translate-page="admin">Tahun Masuk</span> <span
                        class="text-red-500">*</span>
                </label>
                <input type="date" name="tahun_masuk" id="tahun_masuk" value="{{ old('tahun_masuk') }}"
