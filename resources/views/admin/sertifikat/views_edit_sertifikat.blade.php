...
<div class="container mx-auto px-4 py-6">
    <div class="max-w-4xl mx-auto">
        ...
        <div class="flex justify-between items-center mb-6">
            <h1 class="text-2xl font-bold text-gray-800 dark:text-white">Edit Sertifikat</h1>
            ...
            <form method="POST" action="{{ route('admin.sertifikat.update', $sertifikat->id) }}" enctype="multipart/form-data">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div class="col-span-2 md:col-span-1">
                        <label for="nama_sertifikat" class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-2">
                    ...
                    <!-- Lembaga Penerbit -->
                    <div class="col-span-2 md:col-span-1">
                        <label for="lembaga_penerbit" class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-2">
                            Lembaga Penerbit <span class="text-red-500">*</span>
                        </label>
                        <input type="text" 
                               name="lembaga_penerbit" 
                               id="lembaga_penerbit" 
                               value="{{ old('lembaga_penerbit', $sertifikat->lembaga_penerbit) }}" 
                               required
                    ...
                    <div class="col-span-2">
                        <label for="link_sertifikat" class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-2">
                            File Sertifikat 
