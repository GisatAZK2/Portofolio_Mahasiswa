...
@section('content')
                            ...
                            <div class="comment-section px-4 pb-4 bg-white dark:bg-gray-800 hidden rounded-b-xl" id="comments-{{ $post->id_postingan }}">
                                            ...
                                            <div class="flex-1">
                                                ...
                                                <div class="flex justify-end mt-2">
                                                    <button onclick="window.submitComment({{ $post->id_postingan }})"
                                                        ...
                                                        <span data-translate="kirim" data-translate-page="result_search">{{ autoTranslate('Kirim') }}</span>
                                                    </button>
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <div class="text-center py-4 bg-gray-50 dark:bg-gray-700/50 rounded-lg">
                                        <p class="text-sm text-gray-500 dark:text-gray-400">
                                            <a href="{{ route('login') }}" class="text-indigo-600 hover:text-indigo-700 font-medium hover:underline">
                                                <span data-translate="login" data-translate-page="result_search">{{ autoTranslate('Masuk') }}</span>
                                            </a>
                                            <span data-translate="untuk_berkomentar" data-translate-page="result_search">{{ autoTranslate('untuk berkomentar') }}</span>
                                        </p>
                                    </div>
                                @endauth
                                ...
                                <div id="comments-container-{{ $post->id_postingan }}" class="comments-container space-y-4 pr-2">
                                    <div class="text-center py-6 text-gray-400 text-sm">
                                        ...
                                        <span data-translate="memuat_komentar" data-translate-page="result_search">{{ autoTranslate('Memuat komentar...') }}</span>
                                    </div>
                                </div>
                            </div>
                        </div>
    ...
    window.deleteComment = async function (commentId, postinganId, type = 'full') {
        ...
        // Use Swal if available, otherwise fallback to confirm
